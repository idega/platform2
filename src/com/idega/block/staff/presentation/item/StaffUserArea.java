/*
 * $Id: StaffUserArea.java,v 1.1 2005/02/01 13:40:20 laddi Exp $
 ...
 */
public class StaffUserArea extends StaffUserItem {
	...
	protected PresentationObject getItem(IWContext iwc) throws RemoteException {
		...
		String userArea = getBusiness(iwc).getUserArea(user, iwc.getCurrentLocale());
		if (userArea != null) {
			return new Text(userArea);
		}
		return null;
	}
