/*
 * $Id: StaffUserEducation.java,v 1.1 2005/02/01 13:40:20 laddi Exp $
 ...
 */
public class StaffUserEducation extends StaffUserItem {
	...
	protected PresentationObject getItem(IWContext iwc) throws RemoteException {
		...
		String userEducation = getBusiness(iwc).getUserEducation(user, iwc.getCurrentLocale());
		if (userEducation != null) {
			return new Text(userEducation);
		}
		return null;
	}
