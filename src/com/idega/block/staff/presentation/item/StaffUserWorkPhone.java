/*
 * $Id: StaffUserWorkPhone.java,v 1.1 2005/02/01 13:40:20 laddi Exp $
 ...
 */
public class StaffUserWorkPhone extends StaffUserItem {
	...
	protected PresentationObject getItem(IWContext iwc) throws RemoteException {
		...
		try {
			Phone phone = getBusiness(iwc).getUsersWorkPhone(user);
