...
public class FloorBMPBean extends com.idega.data.GenericEntity implements com.idega.block.building.data.Floor {
  ...
  public FloorBMPBean(int id)throws SQLException{
  ...
  public void initializeAttributes() {
    ...
    addAttribute(getBuildingIdColumnName(),"Building",true,true,java.lang.Integer.class,"many-to-one",com.idega.block.building.data.Building.class);
