...
public class ApartmentTypeBMPBean extends com.idega.data.GenericEntity implements com.idega.block.building.data.ApartmentType {



  public ApartmentTypeBMPBean() {

    super();

  }

  public ApartmentTypeBMPBean(int id) throws SQLException{
