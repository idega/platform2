...
public interface Building extends BuildingEntity {
	...
	/**
	 * @see com.idega.block.building.data.BuildingBMPBean#getRenterName
	 */
	public String getRenterName();

	/**
	 * @see com.idega.block.building.data.BuildingBMPBean#getRenterAddress
	 */
	public String getRenterAddress();

	/**
	 * @see com.idega.block.building.data.BuildingBMPBean#getRenterID
	 */
	...
	/**
	 * @see com.idega.block.building.data.BuildingBMPBean#setRenterName
	 */
	public void setRenterName(String name);

	/**
	 * @see com.idega.block.building.data.BuildingBMPBean#setRenterAddress
	 */
	public void setRenterAddress(String address);

	/**
	 * @see com.idega.block.building.data.BuildingBMPBean#setRenterID
	 */
