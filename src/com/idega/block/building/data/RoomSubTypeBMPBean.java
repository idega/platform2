...
public class RoomSubTypeBMPBean extends com.idega.data.GenericEntity implements com.idega.block.building.data.RoomSubType {



  public RoomSubTypeBMPBean() {

    super();

  }

  public RoomSubTypeBMPBean(int id) throws SQLException{
