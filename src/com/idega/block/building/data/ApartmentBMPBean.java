...
public class ApartmentBMPBean extends com.idega.data.GenericEntity implements com.idega.block.building.data.Apartment {



  public ApartmentBMPBean() {

    super();

  }

  public ApartmentBMPBean(int id)throws SQLException{
