...
public class ApartmentBMPBean extends com.idega.block.text.data.TextEntityBMPBean implements com.idega.block.building.data.Apartment {
	...
	public void initializeAttributes() {
		...
		addAttribute(BU_FLOOR_ID, "Floor", true, true, java.lang.Integer.class, "many-to-one", Floor.class);
		addAttribute(	BU_APRT_TYPE_ID,"ApartmentType",true,true,java.lang.Integer.class,"many-to-one",ApartmentType.class);
		addAttribute(RENTABLE, "Leigjanleg", true, true, java.lang.Boolean.class);
		addAttribute(IC_IMAGE_ID, "Mynd", true, true, java.lang.Integer.class);
		addAttribute(UNAVAILABLE_UNTIL, "Frosin", true, true, java.sql.Date.class);
	...
	public Collection ejbFindByType(Integer typeID)throws FinderException{
		...
		query.addCriteria(new MatchCriteria(apartment,BU_APRT_TYPE_ID,MatchCriteria.EQUALS,typeID.intValue()));
		return idoFindPKsBySQL(query.toString());
	}
	
	public Collection ejbFindeByTypeAndComplex(Integer typeID,Integer complexID)throws FinderException{
	...
	public Collection ejbFindByName(String name)throws FinderException{
		Table apartment =new Table(this);
		SelectQuery query =new SelectQuery(apartment);
		query.addCriteria(new MatchCriteria(apartment,NAME,MatchCriteria.EQUALS,name));
		return idoFindPKsBySQL(query.toString());	
	}
	...
	public int ejbHomeGetRentableCount()throws IDOException{
		...
		query.addCriteria(new MatchCriteria(apartment, RENTABLE, MatchCriteria.EQUALS, true));
		return idoGetNumberOfRecords(query.toString());
	}
	
	public int ejbHomeGetTypeAndComplexCount(Integer typeID,Integer complexID)throws IDOException{
		SelectQuery query =getTypeAndComplexQuery(typeID,complexID);
		return idoGetNumberOfRecords(query.toString());
	}
	
	private SelectQuery getTypeAndComplexQuery(Integer typeID,Integer complexID)throws IDORelationshipException{
		Table apartment = new Table(this);
	...
	public Collection ejbFindBySearch(Integer complexID,Integer buildingID,Integer floorID,Integer typeID,Integer categoryID,boolean  order)throws FinderException{
