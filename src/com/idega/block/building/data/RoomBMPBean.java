...
public class RoomBMPBean extends com.idega.data.GenericEntity implements com.idega.block.building.data.Room {
  ...
  public RoomBMPBean(int id)throws SQLException{
