...
public class BuildingBMPBean extends com.idega.data.GenericEntity implements com.idega.block.building.data.Building {



  public BuildingBMPBean() {
  ...
  public BuildingBMPBean(int id)throws SQLException{
