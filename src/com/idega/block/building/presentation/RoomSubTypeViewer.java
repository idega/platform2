...
public class RoomSubTypeViewer extends JModuleObject{

private int room_sub_type_id = 0;
private String style;
private String infoStyle;

public RoomSubTypeViewer(int room_sub_type_id){
    this.room_sub_type_id=room_sub_type_id;
}
    ...
    private void getRoom(ModuleInfo modinfo) throws SQLException {

      RoomSubType room = new RoomSubType(room_sub_type_id);
      ...
      roomTable.add(getRoomTable(room),1,3);
    ...
    private Table getRoomTable(RoomSubType room) throws SQLException {
    ...
    private Form getAllRoomTypes(RoomSubType room) throws SQLException {
