...
public interface BuildingService extends IBOService {
	 ...
	 */
	public Complex storeComplex(Integer complexID, String name, String info, Integer imageID, Integer textID, String flashPageID, Boolean locked) throws RemoteException;

	/**
	 * @see com.idega.block.building.business.BuildingServiceBean#storeBuilding
	 */
	public Building storeBuilding(Integer buildingID, String name, String address, String info, Integer imageID, Integer complexID, Integer textID, Boolean locked) throws RemoteException;

	/**
	 * @see com.idega.block.building.business.BuildingServiceBean#storeFloor
	 */
	public Floor storeFloor(Integer floorID, String name, Integer buildingID, String info, Integer imageID, Integer textID) throws RemoteException;

	/**
	 * @see com.idega.block.building.business.BuildingServiceBean#storeApartmentCategory
	 */
	public ApartmentCategory storeApartmentCategory(Integer categoryID, String name, String info, Integer imageID, Integer textID) throws RemoteException;

	/**
	 * @see com.idega.block.building.business.BuildingServiceBean#storeApartmentType
	 */
	public ApartmentType storeApartmentType(Integer typeID, String name, String info, String abbrev, String extraInfo, Integer planID, Integer imageID, Integer categoryID, Integer textID, Double area, Integer roomcount, Integer rent, Boolean balcony, Boolean bath, Boolean kitchen, Boolean storage, Boolean study, Boolean furniture, Boolean loft, Boolean locked) throws RemoteException;

	/**
	 * @see com.idega.block.building.business.BuildingServiceBean#storeApartment
	 */
	public Apartment storeApartment(Integer apartmentID, String name, String info, Integer floorID, Integer typeID, Boolean rentable, Integer imageID, Integer textID, String apartmentSerialNumber) throws RemoteException;
	 ...
	 */
	public void removeApartmentCategory(Integer categoryID) throws RemoteException;
	 ...
	 */
	public BuildingHome getBuildingHome() throws RemoteException, RemoteException;
	 ...
	 */
	public ApartmentHome getApartmentHome() throws RemoteException, RemoteException;

	/**
	 * @see com.idega.block.building.business.BuildingServiceBean#getApartmentTypeHome
	 */
	public ApartmentTypeHome getApartmentTypeHome() throws RemoteException, RemoteException;

	/**
	 * @see com.idega.block.building.business.BuildingServiceBean#getApartmentCategoryHome
	 */
	public ApartmentCategoryHome getApartmentCategoryHome() throws RemoteException, RemoteException;
	 ...
	 */
	public ApartmentViewHome getApartmentViewHome() throws RemoteException, RemoteException;

	/**
	 * @see com.idega.block.building.business.BuildingServiceBean#getComplexTypeViewHome
	 */
	public ComplexTypeViewHome getComplexTypeViewHome() throws RemoteException, RemoteException;
}