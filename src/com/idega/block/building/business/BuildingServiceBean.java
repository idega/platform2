...
public class BuildingServiceBean extends IBOServiceBean implements BuildingService {
	...
	public ApartmentCategory storeApartmentCategory(Integer categoryID, String name, String info, Integer imageID, Integer textID) {
		try {
			ApartmentCategory category = null;
			if (categoryID!=null && categoryID.intValue() > 0) {
				category = getApartmentCategoryHome().findByPrimaryKey(categoryID);
			}
			else{
