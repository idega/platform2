...
public class ReportCategoryAttributesMaker extends JModuleObject{
  ...
  public ReportCategoryAttributesMaker(){
    sIndex = "0";
    sId = "0";
    sName = "";
    sInfo = "";
  ...
  private boolean saveAttribute(String sAttName,String sAttID,String cid){
    try {
      ...
      if(tid > 0){
        ReportCategoryAttributes rc = new ReportCategoryAttributes();
        rc.setName(sAttName);
  ...
  private DropdownMenu drpAttributes(String sPrm,String selected) {
    ReportCategoryAttributes[] cat = new ReportCategoryAttributes[0];
    try{
      cat = (ReportCategoryAttributes[]) (new ReportCategoryAttributes()).findAll();
    }
