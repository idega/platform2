...
public class MailFinder {
  ...
  public Collection getTopics(int GroupId) {
    ...
    try {
      ...
      Collection L = EntityFinder.getInstance().findAllByColumn(MailTopic.class, com.idega.block.email.data.MailTopicBMPBean.GROUP, GroupId);
  ...
  public Map mapOfTopics(int GroupId) {
    ...
    return EntityFinder.getInstance().getMapOfEntity(getTopics(GroupId), ((MailTopic) com.idega.block.email.data.MailTopicBMPBean.getEntityInstance(MailTopic.class)).getIDColumnName());
