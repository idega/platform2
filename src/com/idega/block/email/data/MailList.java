...
import com.idega.block.email.business.EmailList;
...
public class MailList extends GenericEntity implements EmailList{
   ...
   */
  public MailList(int id) throws SQLException {
    super(id);
  }
