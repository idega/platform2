...
public class ForumThreadBMPBean extends com.idega.data.GenericEntity implements com.idega.block.forum.data.ForumThread {



  public ForumThreadBMPBean() {
  ...
  public ForumThreadBMPBean(int id)throws SQLException{
