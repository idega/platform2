...
public class ForumAdminBMPBean extends com.idega.data.GenericEntity implements com.idega.block.forum.data.ForumAdmin {



  public ForumAdminBMPBean(){
  ...
  public ForumAdminBMPBean(int id) throws SQLException{
