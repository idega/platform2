...
public java.util.Collection findAllThreads(com.idega.core.data.ICCategory p0,int p1)throws javax.ejb.FinderException{
...
public java.util.Collection findNewestThread(com.idega.core.data.ICCategory p0)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
...
public java.util.Collection findAllThreads(com.idega.core.data.ICCategory p0)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
...
public int getNumberOfThreads(com.idega.core.data.ICCategory p0)throws javax.ejb.EJBException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
