...
public class ForumAttributesBMPBean extends com.idega.data.GenericEntity implements com.idega.block.forum.data.ForumAttributes {



  public ForumAttributesBMPBean() {
  ...
  public ForumAttributesBMPBean(int id) throws SQLException {
  ...
  public void insertStartData(){
    ...
    /*try {
      ...
      ForumAttributes fa = ((com.idega.block.forum.data.ForumAttributesHome)com.idega.data.IDOLookup.getHomeLegacy(ForumAttributes.class)).createLegacy();
