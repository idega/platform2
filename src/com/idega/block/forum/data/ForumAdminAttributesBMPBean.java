...
public class ForumAdminAttributesBMPBean extends com.idega.data.GenericEntity implements com.idega.block.forum.data.ForumAdminAttributes {



  public ForumAdminAttributesBMPBean() {
  ...
  public ForumAdminAttributesBMPBean(int id) throws SQLException{
  ...
  public String getEntityName() {
    ...
    return "fo_forum_admin_attributes";
