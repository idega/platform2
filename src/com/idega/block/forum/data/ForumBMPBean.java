...
public class ForumBMPBean extends com.idega.data.GenericEntity implements com.idega.block.forum.data.Forum {
  ...
  public ForumBMPBean(int id) throws SQLException{
