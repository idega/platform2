...
public class ForumEmailBMPBean extends com.idega.data.GenericEntity implements com.idega.block.forum.data.ForumEmail {



  public ForumEmailBMPBean() {
  ...
  public ForumEmailBMPBean(int id) throws SQLException{
