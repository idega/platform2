...
public class GrayForums extends ForumPresentation{

  private String[] Is = {"Umræðuflokkar","Þræðir","Uppfært síðast","Fyrirsögn","Skrá þráð","Efni ","Höfundur ","Svör","Sent","Nafn","Senda"};
  ...
  public GrayForums() throws SQLException {
    super();
    setMenuColor("#4D6476");
    setItemColor("#C5C5C5");
  ...
  public GrayForums(String user_name, int user_id) throws SQLException {
 ...
 //   if (isAdministrator())
 //     Mainframe.add(this.getForumList().getForumInsertButton());
