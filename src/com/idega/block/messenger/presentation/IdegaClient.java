...
public class IdegaClient extends Applet implements Runnable{
  ...
  */
  ...
  private void processPacket(){
    ...
    if( packetFromServlet!=null ){
     ...
     System.err.println("IdegaClient : packetFromServlet == null !!");
    }
...
/**Main method*/
  public static void main(String[] args) {
    ...
    IdegaClient applet=null;
    applet = new IdegaClient();
