 ...
 * insert into im_file_class values(4, 'Tab separatede file', 
 * 'com.idega.block.importer.data.TabSeparatedImportFile',
 * 'A tab separated file read. By default each record is separated with a new line character and each value is separated by a tab, but it can be adjusted by properties.')
 * 
