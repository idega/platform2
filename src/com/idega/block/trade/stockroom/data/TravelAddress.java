...
public class TravelAddress extends GenericEntity {
  ...
  public TravelAddress(int id) throws SQLException {
    super(id);
  }
  ...
  public Address getAddress() {
    try {
      return new Address(getIntColumnValue(getColumnNameAddressId()));
