...
{
 public com.idega.block.trade.stockroom.data.Product updateProduct(com.idega.block.trade.stockroom.data.Product p0)throws com.idega.data.IDOException,javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.List getProducts(com.idega.block.trade.stockroom.data.ProductCategory p0)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.core.data.Address[] getArrivalAddresses(com.idega.block.trade.stockroom.data.Product p0)throws com.idega.data.IDOFinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.trade.stockroom.data.Product getProduct(int p0)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.List getProducts()throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.List getProducts(int p0,com.idega.util.IWTimestamp p1,com.idega.util.IWTimestamp p2)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.List getProducts(com.idega.util.IWTimestamp p0)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.trade.stockroom.data.TravelAddress getDepartureAddress(com.idega.block.trade.stockroom.data.Product p0)throws java.sql.SQLException,com.idega.data.IDOFinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.List getProducts(com.idega.util.IWTimestamp p0,com.idega.util.IWTimestamp p1)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public void deleteProduct(com.idega.block.trade.stockroom.data.Product p0)throws com.idega.data.IDOException,java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.trade.stockroom.data.Product getProduct(java.lang.Integer p0)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.List getProducts(com.idega.core.data.ICCategory p0)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.List getProductCategories()throws com.idega.data.IDOFinderException, java.rmi.RemoteException;
 public java.util.List getDepartureAddresses(com.idega.block.trade.stockroom.data.Product p0,boolean p1)throws com.idega.data.IDOFinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.List getProducts(int p0,com.idega.util.IWTimestamp p1)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.core.data.Address getArrivalAddress(com.idega.block.trade.stockroom.data.Product p0)throws java.sql.SQLException,com.idega.data.IDOFinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.List getProducts(int p0,int p1,com.idega.util.IWTimestamp p2,com.idega.util.IWTimestamp p3)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.List getProductCategories(com.idega.block.trade.stockroom.data.Product p0)throws com.idega.data.IDORelationshipException,java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.List getProducts(java.util.List p0)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
