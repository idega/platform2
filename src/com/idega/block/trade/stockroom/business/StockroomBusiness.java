...
public interface StockroomBusiness extends com.idega.business.IBOService
{
 ...
 public int createPriceCategory(int p0,java.lang.String p1,java.lang.String p2,java.lang.String p3,java.lang.String p4)throws java.sql.SQLException, java.rmi.RemoteException;
 ...
 public float getPrice(int p0,int p1,int p2,java.sql.Timestamp p3,int p4,int p5)throws java.sql.SQLException, java.rmi.RemoteException;
 ...
 public int getUserResellerId(com.idega.presentation.IWContext p0)throws java.lang.RuntimeException,java.sql.SQLException, java.rmi.RemoteException;
 public int getUserResellerId(com.idega.core.user.data.User p0)throws java.lang.RuntimeException,java.sql.SQLException, java.rmi.RemoteException;
 public int getUserSupplierId(com.idega.core.user.data.User p0)throws java.lang.RuntimeException,java.sql.SQLException, java.rmi.RemoteException;
 public int getUserSupplierId(com.idega.presentation.IWContext p0)throws java.lang.RuntimeException,java.sql.SQLException, java.rmi.RemoteException;
 public boolean isBetween(com.idega.util.IWTimestamp p0,com.idega.util.IWTimestamp p1,com.idega.util.IWTimestamp p2,boolean p3,boolean p4) throws java.rmi.RemoteException;
 public boolean isInTimeframe(com.idega.util.IWTimestamp p0,com.idega.util.IWTimestamp p1,com.idega.util.IWTimestamp p2,boolean p3) throws java.rmi.RemoteException;
