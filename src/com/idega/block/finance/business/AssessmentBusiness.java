...
public interface AssessmentBusiness extends com.idega.business.IBOService
{
 ...
 public void assessTariffsToAccount(java.lang.Integer[] p0,java.lang.Double[] p1,int p2,java.util.Date p3,int p4,int p5,int p6)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public void assessTariffsToAccount(java.util.List p0,java.util.List p1,int p2,java.util.Date p3,int p4,int p5,int p6) throws java.rmi.RemoteException;
 ...
 public com.idega.block.finance.data.AccountEntry storeAccountEntry(int p0,int p1,int p2,int p3,float p4,float p5,float p6,java.util.Date p7,java.lang.String p8,java.lang.String p9,java.lang.String p10)throws java.rmi.RemoteException,javax.ejb.CreateException, java.rmi.RemoteException;
}
