...
public interface AccountBusiness extends com.idega.business.IBOService
{
 ...
 public java.util.List listOfPhoneEntries(int p0,com.idega.util.idegaTimestamp p1,com.idega.util.idegaTimestamp p2) throws java.rmi.RemoteException;
 ...
 public java.util.List listOfKeySortedEntries(int p0,com.idega.util.idegaTimestamp p1,com.idega.util.idegaTimestamp p2) throws java.rmi.RemoteException;
 public java.util.List listOfPhoneEntries(int p0,com.idega.util.idegaTimestamp p1,java.lang.String p2) throws java.rmi.RemoteException;
 public java.util.Collection listOfAccounts(int p0) throws java.rmi.RemoteException;
 public java.util.List listOfAccountEntries(int p0,com.idega.util.idegaTimestamp p1,com.idega.util.idegaTimestamp p2) throws java.rmi.RemoteException;
