...
*/
  ...
  private PresentationObject doMainTable(IWContext iwc){
    ...
    drpAccountTypes.addMenuElement(com.idega.block.finance.data.AccountBMPBean.typeFinancial,iwrb.getLocalizedString("financial","Financial"));

    drpAccountTypes.addMenuElement(com.idega.block.finance.data.AccountBMPBean.typePhone,iwrb.getLocalizedString("phone","phone"));
