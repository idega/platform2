...
public interface QueryToSQLBridge extends com.idega.business.IBOService
{
 ...
 public com.idega.block.dataquery.data.QueryResult executeQueries(com.idega.block.dataquery.data.sql.SQLQuery p0,java.util.List p1) throws java.rmi.RemoteException;
}
