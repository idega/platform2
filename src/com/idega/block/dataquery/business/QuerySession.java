...
public interface QuerySession extends com.idega.business.IBOSession
{
 ...
 public void createQuery(int p0,com.idega.presentation.IWContext p1)throws java.rmi.RemoteException,javax.ejb.FinderException, java.rmi.RemoteException;
 public com.idega.block.dataquery.data.xml.QueryHelper getQueryHelper(com.idega.presentation.IWContext p0)throws java.rmi.RemoteException,javax.ejb.FinderException, java.rmi.RemoteException;
