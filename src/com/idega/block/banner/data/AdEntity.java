...
public class AdEntity extends GenericEntity{

	public AdEntity(){
		super();
	}

	public AdEntity(int id)throws SQLException{
		super(id);
	}
  ...
  public void delete() throws SQLException {
    removeFrom(ICFile.getStaticInstance(ICFile.class));
    removeFrom(BannerEntity.getStaticInstance(BannerEntity.class));
    super.delete();
  }
}
