...
public abstract class CategoryEntityBMPBean extends com.idega.data.GenericEntity implements com.idega.block.category.data.CategoryEntity {
  ...
  protected final void afterInitializeAttributes(){
    addAttribute(getColumnCategoryId(),"Category",true,true,Integer.class,"many-to_one",com.idega.block.category.data.ICCategory.class);
  }
