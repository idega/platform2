...
public class ICCategoryHomeImpl extends IDOFactory implements ICCategoryHome {
    ...
    public List getListOfCategoryForObjectInstance(ICObjectInstance obj,
        ...
        List theReturn = ((ICCategoryBMPBean) entity)
                .ejbHomeGetListOfCategoryForObjectInstance(obj, order);
    ...
    public List getListOfRootCategoryForObjectInstance(ICObjectInstance obj,
        ...
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        List theReturn = ((ICCategoryBMPBean) entity)
                .ejbHomeGetListOfRootCategoryForObjectInstance(obj, order);
        this.idoCheckInPooledEntity(entity);
        return theReturn;
    }
    ...
    public int getOrderNumber(Category category, ICObjectInstance instance)
            throws javax.ejb.FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        int theReturn = ((ICCategoryBMPBean) entity).ejbHomeGetOrderNumber(
                category, instance);
        this.idoCheckInPooledEntity(entity);
        return theReturn;
    }
    ...
    public boolean setOrderNumber(Category category, ICObjectInstance instance,
        ...
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        boolean theReturn = ((ICCategoryBMPBean) entity).ejbHomeSetOrderNumber(
                category, instance, orderNumber);
        this.idoCheckInPooledEntity(entity);
        return theReturn;
    }
    ...
    public Collection findRootsByType(String type) throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ICCategoryBMPBean) entity)
                .ejbFindRootsByType(type);
        this.idoCheckInPooledEntity(entity);
    ...
    public Collection findAllByObjectInstance(int iObjectInstanceID)
        ...
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ICCategoryBMPBean) entity)
                .ejbFindAllByObjectInstance(iObjectInstanceID);
        this.idoCheckInPooledEntity(entity);
        return this.getEntityCollectionForPrimaryKeys(ids);
    }
    ...
    public Collection findAllByObjectInstance(ICObjectInstance instance)
        ...
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ICCategoryBMPBean) entity)
                .ejbFindAllByObjectInstance(instance);
        this.idoCheckInPooledEntity(entity);
        return this.getEntityCollectionForPrimaryKeys(ids);
    }
