/*
 *  $Id: TPosAuthorisationEntriesBean.java,v 1.1 2002/03/14 13:07:17 palli Exp $
 *
 ...
 * @version   1.0
 */
public class TPosAuthorisationEntriesBean extends GenericEntity implements TPosAuthorisationEntries {
   ...
   */
  public TPosAuthorisationEntriesBean() {
    super();
  }
   ...
   */
  public TPosAuthorisationEntriesBean(int id) throws SQLException {
    super(id);
  }
