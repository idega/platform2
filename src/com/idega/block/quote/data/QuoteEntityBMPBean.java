...
public class QuoteEntityBMPBean extends com.idega.data.GenericEntity implements com.idega.block.quote.data.QuoteEntity {



  public QuoteEntityBMPBean(){
  ...
  public QuoteEntityBMPBean(int id)throws SQLException{
