 ...
 * $Id: ContractBusiness.java,v 1.2 2002/04/06 18:52:27 tryggvil Exp $
...
public  class ContractBusiness {
	...
	public static void setContractStatus(int iContractId,String status){
      ...
      Contract C = ((com.idega.block.contract.data.ContractHome)com.idega.data.IDOLookup.getHomeLegacy(Contract.class)).findByPrimaryKeyLegacy(iContractId );
  ...
  public static void resignContract(int iContractId){
	...
	public static boolean  deleteTag(int id){
	  ...
	  if(id > 0){
			...
			try {
				...
				((com.idega.block.contract.data.ContractTagHome)com.idega.data.IDOLookup.getHomeLegacy(ContractTag.class)).findByPrimaryKeyLegacy(id).delete();
	...
	public static void saveTag(int iTagId,String sName,String sInfo,boolean inUse,boolean inList,int iCategoryId){
	  ...
	  try {
			...
			ContractTag tag = ((com.idega.block.contract.data.ContractTagHome)com.idega.data.IDOLookup.getHomeLegacy(ContractTag.class)).createLegacy();

			boolean update = false;

			if(iTagId > 0){

				tag = ((com.idega.block.contract.data.ContractTagHome)com.idega.data.IDOLookup.getHomeLegacy(ContractTag.class)).findByPrimaryKeyLegacy(iTagId);
	  ...
	  int id = -1;
		...
		try {
			...
			if(iCategoryId > 0){
			  ...
			  cat = ((com.idega.block.contract.data.ContractCategoryHome)com.idega.data.IDOLookup.getHomeLegacy(ContractCategory.class)).findByPrimaryKeyLegacy(iCategoryId);
			...
			if(iObjectInstanceId > 0){
				...
				objIns.removeFrom(((com.idega.block.contract.data.ContractCategoryHome)com.idega.data.IDOLookup.getHomeLegacy(ContractCategory.class)).createLegacy());
  ...
  public static boolean deleteBlock(int instanceid){
    ...
    //  List O = TextFinder.listOfObjectInstanceTexts();
      ...
      ContractCategory nc = ((com.idega.block.contract.data.ContractCategoryHome)com.idega.data.IDOLookup.getHomeLegacy(ContractCategory.class)).findByPrimaryKeyLegacy( iCategoryId );
    ...
    try {
      ...
      ((com.idega.block.contract.data.ContractHome)com.idega.data.IDOLookup.getHomeLegacy(Contract.class)).findByPrimaryKeyLegacy(iContractId ).delete();
    ...
    if(iTextId > 0){
      ...
      try{
        ...
        CT = ((com.idega.block.contract.data.ContractTextHome)com.idega.data.IDOLookup.getHomeLegacy(ContractText.class)).findByPrimaryKeyLegacy(iTextId);
    ...
    if(iTextId > 0){
      ...
      try {
        ...
        ((com.idega.block.contract.data.ContractTextHome)com.idega.data.IDOLookup.getHomeLegacy(ContractText.class)).findByPrimaryKeyLegacy(iTextId).delete();
	...
	public static boolean updateCategoryDescription(int id ,String description){
	  ...
	  try {
			...
			ContractCategory cat = ((com.idega.block.contract.data.ContractCategoryHome)com.idega.data.IDOLookup.getHomeLegacy(ContractCategory.class)).findByPrimaryKeyLegacy(id);
