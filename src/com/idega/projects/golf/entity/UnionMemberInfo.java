...
public class UnionMemberInfo extends GolfEntity {
    ...
    public void initializeAttributes() {
        ...
        addAttribute("family_id","Fjölskylda",false,false,"java.lang.Integer","many-to-one","com.idega.projects.golf.entity.Family");
        addAttribute("family_status","Fjölskyldustaða",true,true,"java.lang.String");
        addAttribute("card_id","Greiðslukort",false,false,"java.lang.Integer","one-to-one","com.idega.projects.golf.entity.Card");

        addAttribute("payment_type_id","Greiðslumáti",true,true,"java.lang.Integer","one-to-many","com.idega.projects.golf.entity.PaymentType");
