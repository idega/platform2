...
public class Poll_result extends GolfEntity{

	public Poll_result(){
		super();	
	}
	
	public Poll_result(int id)throws SQLException{
		super(id);
	}
...
//		addAttribute("poll_result_id", "Spurning", true, true, "java.lang.Integer","many-to-one","com.idega.projects.golf.entity.Poll");
