...
public class Payment extends GolfEntity{
	...
	public void initializeAttributes(){
		...
		addAttribute("price_catalogue_id","Tegund",true,true,"java.lang.Integer","one-to-many","com.idega.projects.golf.entity.PriceCatalogue");
		...
		addAttribute("payment_type_id","Tegund",true,true,"java.lang.Integer","one-to-many","com.idega.projects.golf.entity.PaymentType");
                ...
                addAttribute("round_id", "Umferð", true, true, "java.lang.Integer","one-to-many","com.idega.projects.golf.entity.PaymentRound");
