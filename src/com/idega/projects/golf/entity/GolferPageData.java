...
public class GolferPageData extends GenericEntity {
  ...
  public GolferPageData() {

  }

  public GolferPageData(int id) throws SQLException{
    super(id);
  }

  public void initializeAttributes() {
    this.addAttribute( MEMBER_ID, "member_id", true, false, Integer.class, "one_to_many", com.idega.projects.golf.entity.UnionMemberInfo.class);
