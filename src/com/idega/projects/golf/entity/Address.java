...
public class Address extends GolfEntity{
	...
	public void initializeAttributes(){
		...
		addAttribute("zipcode_id", "Póstnúmer", true, true, "java.lang.Integer", "one-to-many","com.idega.projects.golf.entity.ZipCode");
