...
*@version 1.0
*/
public class TournamentDay extends GolfEntity{

	public TournamentDay(){
		super();
	}

	public TournamentDay(int id)throws SQLException{
		super(id);
	}
	...
	//par1: column name, par2: visible column name, par3-par4: editable/showable, par5 ...
		...
		addAttribute("tournament_id","Mót",true,true,"java.lang.Integer","many-to-one","com.idega.projects.golf.entity.Tournament");
