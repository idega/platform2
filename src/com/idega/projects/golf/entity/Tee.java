...
public class Tee extends GolfEntity{

	public Tee(){
		super();
	}

	public Tee(int id)throws SQLException{
		super(id);
	}
	...
	public void initializeAttributes(){
		...
		addAttribute("tee_color_id","Teigur", true, true, "java.lang.Integer","one-to-many","com.idega.projects.golf.entity.TeeColor");
