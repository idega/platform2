...
public class TournamentScorecard extends GolfEntity{
	...
	public int getDifference(){
        ...
        public static TournamentScorecard getScorecard(int tournament_round_id,int member_id) {
            ...
            try {
                java.util.List scoreCards = EntityFinder.findAllByColumn(new TournamentScorecard(),"tournament_round_id",tournament_round_id+"","member_id",member_id+"");
                if (scoreCards != null) {
