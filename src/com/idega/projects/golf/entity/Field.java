...
*@version 1.2
*/
public class Field extends GolfEntity{

	public Field(){
		super();
	}

	public Field(int id)throws SQLException{
		super(id);
	}
	...
	public void initializeAttributes(){
		...
		addAttribute("union_id","Eigandi Samband/Klúbbur",true,true,"java.lang.Integer","one-to-many","com.idega.projects.golf.entity.Union");
