...
public class MemberLogin extends Editor{
  ...
  protected void control(IWContext iwc){
    ...
    if(member_id != null && union_id != null){
      try{
        ...
        this.addLinks(formatText("Aðgangsorð"));
  ...
  private PresentationObject doView(Member member,String sUserLogin){
    ...
    T.add(tUsrLgn,1,4);
    T.add(formatText("Lykilorð"),1,5);
    T.add(psw1,1,6);
    T.add(formatText("Staðfesting"),1,7);
    T.add(psw2,1,8);
