...
public class TariffService  {
  ...
  static public void makePayment(int memberID,int iUnionId ,int RoundId, int Price , boolean Status , String Name, String Info , int InstallmentNumber, int Totalinstallments, int PaymentTypeID, Timestamp PayDate ,Timestamp last_updated, int cashier_id) throws SQLException {
  ...
  static public int makeNewAccount(int MemberId,int UnionId,String Name,int CashierId){
