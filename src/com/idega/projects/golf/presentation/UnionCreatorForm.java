...
import com.idega.projects.golf.entity.Country;
...
public class UnionCreatorForm extends Block {
  ...
  private void processForm(IWContext iwc)throws Exception{
      ...
      com.idega.projects.golf.business.UnionCreator.createUnion(name,type,abbreviation,loginName,passwd,parent,CountryID,city,zipcode);
  }
