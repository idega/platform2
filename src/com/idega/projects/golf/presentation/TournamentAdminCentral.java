        ...
        try {
            if (AccessControl.isAdmin(iwc)){
                ...
                if (AccessControl.isClubAdmin(iwc)){
                    ...
                    Link lCreateTournament = this.getAdminButton("com.idega.projects.golf.presentation.TournamentCreator","Smíða mót");
                    dialog.add(lCreateTournament);

                    dialog.add("<br>");

                    Link lModifyTournament = this.getAdminButton("com.idega.projects.golf.presentation.TournamentModifier","Breyta mót");
                    dialog.add(lModifyTournament);

                    dialog.add("<br>");

                    Link lRegisterMember = this.getAdminButton("com.idega.projects.golf.presentation.TournamentMemberRegistration","Skrá kylfing");
                    dialog.add(lRegisterMember);

                    dialog.add("<br>");

                    Link lTournamentGroups = this.getAdminButton("com.idega.projects.golf.presentation.TournamentGroups","Mótshópar");
