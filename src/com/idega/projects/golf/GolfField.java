...
public class GolfField{
	...
	public GolfField (String open_time, String close_time, int interval, int field_id, String date, int days_shown){
	...
	public GolfField (int open_hour, int open_min, int close_hour, int close_min, int interval, int field_id, String date, int days_shown){
