...
public class ProjectExtra extends GenericEntity{
	...
	public void initializeAttributes(){
		...
		addAttribute("description","lýsing",true,true,"java.lang.String",5000);
		addAttribute("goals","markmið",true,true,"java.lang.String",5000);
		addAttribute("finances","fjármál",true,true,"java.lang.String",5000);
		addAttribute("tasks","verkliðir",true,true,"java.lang.String",5000);
	}
