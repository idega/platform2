...
public class Menu extends JModuleObject{
  ...
  private void doAct(){
    ...
    //LinkTable.setHeight(1,1,"25");
    int iWidht = 130;
    int iHeight = 17;

    Image menu1 = new Image(iAct != ACT1?"/pics/menu/info.gif":"/pics/menu/info1.gif");
    //menu1.setWidth(iWidth);
    //menu1.setHeight(iHeight);
   ...
   // menu2.setWidth(iWidht);
   // menu2.setHeight(iHeight);
    ...
    //menu3.setWidth(iWidht);
    //menu3.setHeight(iHeight);
    ...
    //menu4.setWidth(iWidht);
    //menu4.setHeight(iHeight);
   ...
   // menu5.setWidth(iWidht);
   // menu5.setHeight(iHeight);
    ...
    //menu7.setWidth(iWidht);
    //menu7.setHeight(iHeight);
  ...
  private String getUrl(int act){
    String url = "";
      ...
      //case ACT8:  url =  "/index2.jsp";       break;
  ...
  private Image getT(){
    ...
    switch (iAct) {
      ...
      //case ACT8:  TitleUrl = "/pics/titles/"+lang+"/english2.gif";    break;
