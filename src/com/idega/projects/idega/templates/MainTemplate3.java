...
public abstract class MainTemplate3 extends JSPModule implements JspPage{
	...
	public Table template() {
		...
		Table borderTable = new Table(1,1);
			...
			//outerTable.setHeight(2,1,"100%");
                ...
                Image staffImage = new Image("/pics/undirsida/starfsmenn1.gif","Staff",70,17);
                Image productsImage = new Image("/pics/undirsida/vorur1.gif","Products",43,17);
                Image customersImage = new Image("/pics/undirsida/vidskiptavinir1.gif","Customers",85,17);
                Image associatesImage = new Image("/pics/undirsida/samstarfsadilar1.gif","Associates",91,17);
                Image supportImage = new Image("/pics/undirsida/adstod1.gif","Support",49,17);
                Image homeImage = new Image("/pics/undirsida/heim.gif","Home",40,17);
		...
		//linkTable.add(supportLink,1,1);
			...
			tafla.setVerticalAlignment(1,1,"top");
                ...
                Paragraph idegaParagraph = new Paragraph("center","idega","idega");
                  idegaParagraph.add("idega hf. | Bæjarlind 14 - 16 | sími: 554 - 7557 | fax: 554 - 7749 | email: <a href=\"mailto:idega@idega.is\">idega@idega.is</a> | vefur: <a href=\"http://www.idega.is\">www.idega.is</a>");
