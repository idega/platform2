...
public class HysingAssociatesTemplate extends HysingTemplate{
  ...
  public void initializePage(){
        ...
        page.setClickedMenuItem("associates");
        page.setMainBoxHeader("samstarfsaðilar");
        page.setLeftBoxHeader("samstarfsaðilar");
        page.setRightBoxHeader("tenglar");
        setPage(page);
  }
  ...
  public void initializePage(){
	...
	public Table template(){
		...
		if (myTable == null){
			...
			myTable.setBackgroundImage(1,1,new Image("/pics/headers/samstarfsadilar/samstarfsadilar_Topp.jpg"));
			...
			Table innerTable = new Table(1,2);
				...
				innerTable.setBackgroundImage(new Image("/pics/headers/samstarfsadilar/2samstarfs1a.gif"));
	...
	public Table menubar() {
		...
		Table menuTable = new Table(13,1);
			...
			menuTable.add(menuItemBlueL,10,1);
			menuTable.add(button5s,11,1);
			menuTable.add(menuItemBlueR,12,1);
	...
	public Table template2(){
		...
		if (myTable2 == null){
			...
			Text textText = new Text("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;samstarfsaðilar");
