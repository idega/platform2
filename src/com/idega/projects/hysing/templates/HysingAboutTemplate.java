...
public class HysingAboutTemplate extends HysingTemplate{
  ...
  public void initializePage(){
        ...
        page.setClickedMenuItem("about");
        page.setMainBoxHeader("um fyrirtækið");
        page.setLeftBoxHeader("um fyrirtækið");
  ...
  public void main(ModuleInfo modinfo){
	...
	public Table template(){
		...
		if (myTable == null){
			...
			myTable.setBackgroundImage(1,1,new Image("/pics/headers/umfyrirtaekid/umFyrirtaekid_Topp.jpg"));
			...
			Table innerTable = new Table(1,2);
				...
				innerTable.setBackgroundImage(new Image("/pics/headers/umfyrirtaekid/2umfyrirtaekid1a.gif"));
	...
	public Table menubar() {
		...
		Table menuTable = new Table(13,1);
			...
			menuTable.add(menuItemBrownL,4,1);
			menuTable.add(button2s,5,1);
			menuTable.add(menuItemBrownR,6,1);
	...
	public Table template2(){
		...
		if (myTable2 == null){
			...
			Text textText = new Text("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;um&nbsp;fyrirtækið");
