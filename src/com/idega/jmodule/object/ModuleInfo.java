...
public ModuleInfo(HttpServletRequest Request,HttpServletResponse Response,String language){
	this.Request=Request;
	this.Response=Response;
...
public ModuleInfo(HttpServletRequest Request,HttpServletResponse Response,HttpSession session){
	this.Request=Request;
	this.Response=Response;
	setLanguage(getRightLanguage(Request,Response));
	setAllDefault();
