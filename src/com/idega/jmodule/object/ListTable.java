...
//  protected boolean finalRows;
  ...
  public ListTable( ModuleObject[] obj, int numberOfColumns ){
    super();
    tableRows = 1;
    tableColumns = 1;
    rowToAddIn = 1;
  ...
  public void doTable(ModuleObject[] obj, int numberOfColumns ){
...
/*
  public void doTable(Vector ofString, String colORrows, int numberOf_ ){
    int vectorSize = ofModuleObjects.size();
    ...
    for (int i = 0; i < vectorSize; i++ ){
//      try{
        this.addText((String)ofModuleObjects.elementAt(i));
