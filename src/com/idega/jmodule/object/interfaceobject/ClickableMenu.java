...
public class ClickableMenu extends InterfaceObjectContainer{
  ...
  public void addMenuItem(String menuItemName,ModuleObject ItemDisplayedIfNotClicked,ModuleObject ItemDisplayedIfClicked){
  ...
  public ModuleObject getMenuItem(String menuItemName){
      if(menuItemName.equals(this.getClickedMenuItemName())){
        return (ModuleObject)clickedItems.get(menuItemName);
      }
      else{
        return (ModuleObject)notClickedItems.get(menuItemName);
      }
  }
