...
public class TimesheetService {
       ...
       */
      public static Project[] getAllProjects(IWContext iwc) throws SQLException {
          Project[] allProjects = (Project[]) iwc.getApplicationAttribute("i_timesheet_all_projects_array");
       ...
       */
      public static Project[] getAllProjectsOrderByProjectNumber(IWContext iwc) throws SQLException {
       ...
       */
      public static Project[] getAllProjects(IWContext iwc, String order_by) throws SQLException{
          Project[] allProjects = (Project[]) iwc.getApplicationAttribute("i_timesheet_all_projects_array_"+TextSoap.findAndCut(order_by,","));
