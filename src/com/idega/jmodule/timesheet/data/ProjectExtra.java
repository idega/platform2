...
public class ProjectExtra extends GenericEntity{
	...
	public void initializeAttributes(){
		...
		addAttribute("goals","markmið",true,true,"java.lang.String");
		addAttribute("finances","fjálmál",true,true,"java.lang.String");
		addAttribute("tasks","verkliðir",true,true,"java.lang.String");
	}
