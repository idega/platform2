...
*/
  ...
  public int newForum(String name, String description)throws SQLException{
  ...
  public int getDefaultAttributeForumID(int attribute_id, String attribute_name)throws SQLException{
    ...
    if (forums.length > 0){
      ...
      toreturn = newForum("Golfumræða", "Umræða sérstaklega ætluð fyrir umræður innan klúbbanna");
  ...
  public ForumAttributes[] getForumAttributes(int attribute_id, String attribute_name)throws SQLException{
   if (myForumAttributes == null)
    ...
    ForumAttributes[] forums ={new ForumAttributes(1)};
    ForumAttributes[] forums2 = (ForumAttributes[])myForumAttributes.findAllByColumn("attribute_name",attribute_name,"attribute_id", "" + attribute_id);
