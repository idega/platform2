/*
 * $Id: CitizenAccountBusiness.java,v 1.28 2005/04/06 08:28:02 anna Exp $
 * Created on 6.4.2005
 *
...
/**
 * <p>
 * TODO anna Describe Type CitizenAccountBusiness
 * </p>
...
public interface CitizenAccountBusiness extends IBOService, AccountBusiness {
	 ...
	 */
	public Integer insertApplication(IWContext iwc, User user, String ssn, String email, String phoneHome,
			String phoneWork) throws UserHasLoginException, java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#insertApplication
	 */
	public Integer insertApplication(IWContext iwc, User user, String ssn, String email, String phoneHome,
			String phoneWork, boolean sendEmail) throws UserHasLoginException, java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#insertApplication
	 */
	public Integer insertApplication(IWContext iwc, String name, String ssn, String email, String phoneHome,
			String phoneWork, String careOf, String street, String zipCode, String city, String civilStatus,
			boolean hasCohabitant, int childrenCount, String applicationReason) throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#insertCohabitant
	 */
	public Integer insertCohabitant(Integer applicationId, String firstName, String lastName, String ssn,
			String civilStatus, String phoneWork) throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#insertChildren
	 */
	public Integer insertChildren(Integer applicationId, String firstName, String lastName, String ssn)
			throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#insertMovingTo
	 */
	public Integer insertMovingTo(Integer applicationId, String address, String date, String housingType,
			String propertyType, String landlordName, String landlordPhone, String landlordAddress)
			throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#insertPutChildren
	 */
	public Integer insertPutChildren(Integer applicationId, String currentCommuneID) throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#findCitizenApplicantPutChildren
	 */
	public CitizenApplicantPutChildren findCitizenApplicantPutChildren(int applicationId) throws RemoteException,
			FinderException;
	 ...
	 */
	public CitizenApplicantChildren[] findCitizenApplicantChildren(int applicationId) throws RemoteException,
			FinderException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#findCitizenApplicantCohabitant
	 */
	public CitizenApplicantCohabitant findCitizenApplicantCohabitant(int applicationId) throws RemoteException,
			FinderException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#findCitizenApplicantMovingTo
	 */
	public CitizenApplicantMovingTo findCitizenApplicantMovingTo(int applicationId) throws RemoteException,
			FinderException;
	 ...
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#getUser
	 */
	public User getUser(String ssn, Locale locale) throws java.rmi.RemoteException;
	 ...
	 */
	public List getListOfUnapprovedApplications() throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#getAccount
	 */
	public CitizenAccount getAccount(int id) throws FinderException, java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#acceptApplication
	 */
	public void acceptApplication(int applicationID, User performer, boolean createUserMessage,
			boolean createPasswordMessage, boolean sendEmail) throws CreateException, java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#removeApplication
	 */
	public void removeApplication(int applicationId, User performer) throws RemoteException, FinderException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#rejectApplication
	 */
	public void rejectApplication(int applicationID, User performer, String reasonDescription) throws RemoteException,
	 ...
	 */
	public Collection getAllAcceptedApplications() throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#getAllPendingApplications
	 */
	public Collection getAllPendingApplications() throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#getAllRejectedApplications
	 */
	public Collection getAllRejectedApplications() throws java.rmi.RemoteException;
	...
	public void changePasswordAndSendLetterOrEmail(IWUserContext iwuc, LoginTable loginTable, User user,
			String newPassword, boolean sendLetter) throws CreateException, java.rmi.RemoteException;
	...
	/**
	 * @see se.idega.idegaweb.commune.account.citizen.business.CitizenAccountBusinessBean#hasAccountApplication
	 */
	public boolean hasAccountApplication(String personalID) throws java.rmi.RemoteException;
}
