...
public interface ProviderApplication extends com.idega.data.IDOEntity,com.idega.block.process.data.Case,se.idega.idegaweb.commune.account.data.AccountApplication
{
 ...
 public void setSchoolType(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.lang.String getAddress() throws java.rmi.RemoteException;
 public void setSchoolType(com.idega.block.school.data.SchoolType p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.school.data.SchoolType getSchoolType() throws java.rmi.RemoteException;
