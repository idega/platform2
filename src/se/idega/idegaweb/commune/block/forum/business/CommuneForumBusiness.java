...
public interface CommuneForumBusiness extends com.idega.business.IBOService
{
 ...
 public int getFileCount(com.idega.core.category.data.ICCategory p0) throws java.rmi.RemoteException;
 public com.idega.core.category.data.ICCategoryHome getICCategoryHome()throws com.idega.data.IDOLookupException, java.rmi.RemoteException;
 ...
 public com.idega.user.data.User getModerator(com.idega.core.category.data.ICCategory p0) throws java.rmi.RemoteException;
 public boolean isModerator(com.idega.core.category.data.ICCategory p0,com.idega.user.data.User p1) throws java.rmi.RemoteException;
