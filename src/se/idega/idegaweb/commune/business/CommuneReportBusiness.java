...
public interface CommuneReportBusiness extends com.idega.business.IBOSession
{
 ...
 public com.idega.block.datareport.util.ReportableCollection getCitizensRelatedToChildCareAndHaveChangedStatusInSelectedPeriod(java.sql.Date p1,java.sql.Date p2,java.sql.Date p3,java.sql.Date p4)throws java.rmi.RemoteException,javax.ejb.CreateException,javax.ejb.FinderException, java.rmi.RemoteException;
