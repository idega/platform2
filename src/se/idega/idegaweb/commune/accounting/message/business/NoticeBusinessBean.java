/*
 * $Id: NoticeBusinessBean.java,v 1.4 2003/09/25 10:12:34 anders Exp $
 *
 ...
 * <p>
 * Last modified: $Date: 2003/09/25 10:12:34 $ by $Author: anders $
 *
				...
				if (sc.equals(childCareCategoryId)) {
					...
					while (iter2.hasNext()) {
						...
						if (headmasterUserId > 0) {
							...
							if (!school.getCentralizedAdministration() && !provider.getPaymentByInvoice()) {
