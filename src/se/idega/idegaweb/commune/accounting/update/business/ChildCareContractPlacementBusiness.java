...
{
 public se.idega.idegaweb.commune.accounting.childcare.data.ChildCareApplicationHome getChildCareApplicationHome() throws java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.childcare.data.ChildCareContractHome getChildCareContractHome() throws java.rmi.RemoteException;
