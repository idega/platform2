package se.idega.idegaweb.commune.accounting.export.raindance.presentation;
...
import se.idega.idegaweb.commune.accounting.export.raindance.business.RaindanceBusiness;
...
public class CreateRaindanceFiles extends AccountingBlock {
	...
	private void createFiles(IWContext iwc) {
		...
		try {
			getRaindanceBusiness(iwc).createFiles(_currentOperation, pDate,
	...
	private RaindanceBusiness getRaindanceBusiness(IWContext iwc)
			throws RemoteException {
		return (RaindanceBusiness) com.idega.business.IBOLookup
				.getServiceInstance(iwc, RaindanceBusiness.class);
	}
