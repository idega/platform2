...
public interface RegulationsBusiness extends com.idega.business.IBOService
{
 ...
 public se.idega.idegaweb.commune.accounting.regulations.data.PostingDetail getPostingDetailForContract(float p0,se.idega.idegaweb.commune.childcare.data.ChildCareContract p1,se.idega.idegaweb.commune.accounting.regulations.data.Regulation p2,java.sql.Date p3,java.util.Collection p4)throws se.idega.idegaweb.commune.accounting.regulations.business.BruttoIncomeException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.regulations.data.PostingDetail getPostingDetailForPlacement(float p0,com.idega.block.school.data.SchoolClassMember p1,se.idega.idegaweb.commune.accounting.regulations.data.Regulation p2,java.sql.Date p3,java.util.Collection p4)throws se.idega.idegaweb.commune.accounting.regulations.business.BruttoIncomeException, java.rmi.RemoteException;
