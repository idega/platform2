...
public interface RegulationsBusiness extends com.idega.business.IBOService
{
 ...
 public se.idega.idegaweb.commune.accounting.regulations.data.PostingDetail getPostingDetailByOperationFlowPeriodConditionTypeRegSpecType(java.lang.String p0,java.lang.String p1,java.sql.Date p2,java.lang.String p3,java.lang.String p4,java.util.Collection p5,float p6,se.idega.idegaweb.commune.childcare.data.ChildCareContract p7)throws se.idega.idegaweb.commune.accounting.regulations.business.RegulationException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.regulations.data.PostingDetail getPostingDetailForContract(float p0,se.idega.idegaweb.commune.childcare.data.ChildCareContract p1,se.idega.idegaweb.commune.accounting.regulations.data.Regulation p2) throws java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.regulations.data.PostingDetail getPostingDetailForPlacement(float p0,com.idega.block.school.data.SchoolClassMember p1,se.idega.idegaweb.commune.accounting.regulations.data.Regulation p2) throws java.rmi.RemoteException;
