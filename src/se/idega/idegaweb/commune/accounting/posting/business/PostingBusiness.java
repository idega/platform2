...
public interface PostingBusiness extends com.idega.business.IBOService
{
 ...
 public se.idega.idegaweb.commune.accounting.posting.data.PostingParameters getPostingParameter(java.sql.Date p0,int p1,int p2,String p3,int p4)throws se.idega.idegaweb.commune.accounting.posting.business.PostingParametersException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.posting.data.PostingParameters getPostingParameter(java.sql.Date p0,int p1,int p2,String p3,int p4,int p5,int p6)throws se.idega.idegaweb.commune.accounting.posting.business.PostingParametersException, java.rmi.RemoteException;
 ...
 public String[] getPostingStrings(com.idega.presentation.IWContext iwc, com.idega.block.school.data.SchoolCategory category, com.idega.block.school.data.SchoolType type, se.idega.idegaweb.commune.accounting.regulations.data.Regulation reg, se.idega.idegaweb.commune.accounting.school.data.Provider provider, java.sql.Date date) throws PostingException;
