...
public interface ResourceBusiness extends com.idega.business.IBOService
{
 ...
 public void createResourcePlacement(int p0,int p1,java.lang.String p2,java.lang.String p3,int p4)throws java.rmi.RemoteException,se.idega.idegaweb.commune.accounting.extra.business.DateException,se.idega.idegaweb.commune.accounting.extra.business.ResourceException,se.idega.idegaweb.commune.accounting.extra.business.ClassMemberException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.extra.data.ResourceClassMember createResourcePlacement(int p0,int p1,java.lang.String p2)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.extra.data.ResourceClassMember createResourcePlacement(int p0,int p1,java.lang.String p2,int p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public void createResourcePlacement(int p0,int p1,java.lang.String p2,java.lang.String p3,int p4,boolean p5)throws java.rmi.RemoteException,se.idega.idegaweb.commune.accounting.extra.business.DateException,se.idega.idegaweb.commune.accounting.extra.business.ResourceException,se.idega.idegaweb.commune.accounting.extra.business.ClassMemberException, java.rmi.RemoteException;
 ...
 public void finishResourceClassMember(java.lang.Integer p0,java.lang.Integer p1,java.lang.String p2,java.lang.String p3)throws javax.ejb.FinderException,java.rmi.RemoteException,se.idega.idegaweb.commune.accounting.extra.business.DateException,se.idega.idegaweb.commune.accounting.extra.business.ClassMemberException, java.rmi.RemoteException;
 public void finishResourceClassMember(java.lang.Integer p0,java.lang.Integer p1,java.lang.String p2,java.lang.String p3,boolean p4)throws javax.ejb.FinderException,java.rmi.RemoteException,se.idega.idegaweb.commune.accounting.extra.business.DateException,se.idega.idegaweb.commune.accounting.extra.business.ClassMemberException, java.rmi.RemoteException;
 ...
 public java.util.Map getRelatedSchoolTypes(se.idega.idegaweb.commune.accounting.extra.data.Resource p0) throws java.rmi.RemoteException;
 public java.util.Map getRelatedSchoolYears(se.idega.idegaweb.commune.accounting.extra.data.Resource p0) throws java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.extra.data.Resource getResourceByName(java.lang.String p0) throws java.rmi.RemoteException;
 public se.idega.idegaweb.commune.accounting.extra.data.Resource getResourceByPrimaryKey(java.lang.Integer p0) throws java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.accounting.extra.data.ResourcePermission getRscPermByRscAndGrpId(java.lang.Integer p0,java.lang.Integer p1) throws java.rmi.RemoteException;
 ...
 public void saveResource(boolean p0,java.lang.String p1,int[] p2,int[] p3,boolean p4,boolean p5,int p6,int p7)throws se.idega.idegaweb.commune.accounting.extra.business.ResourceException, java.rmi.RemoteException;
}
