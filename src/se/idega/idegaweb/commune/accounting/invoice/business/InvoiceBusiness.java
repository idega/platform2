...
public interface InvoiceBusiness extends com.idega.business.IBOService
{
 ...
 public java.util.Collection findInvoiceRecordsByContract(se.idega.idegaweb.commune.childcare.data.ChildCareContract p0)throws javax.ejb.FinderException, java.rmi.RemoteException;
