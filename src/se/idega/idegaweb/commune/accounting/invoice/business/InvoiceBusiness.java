...
public interface InvoiceBusiness extends com.idega.business.IBOService
{
 ...
 public void removePreliminaryPayment(com.idega.util.CalendarMonth month, java.lang.String category) throws javax.ejb.RemoveException;
	...
	se.idega.idegaweb.commune.accounting.invoice.data.PaymentRecord createVatPaymentRecord(se.idega.idegaweb.commune.accounting.invoice.data.PaymentRecord previousPaymentRecord,se.idega.idegaweb.commune.accounting.regulations.data.PostingDetail postingDetail,float months, com.idega.block.school.data.School school, com.idega.block.school.data.SchoolType sType,com.idega.block.school.data.SchoolYear sYear) throws javax.ejb.CreateException, com.idega.data.IDOLookupException;
}
