...
public interface InvoiceBusiness extends com.idega.business.IBOService
{
 ...
 public void removePreliminaryPayment(com.idega.util.CalendarMonth month, java.lang.String category) throws javax.ejb.RemoveException;
	...
	se.idega.idegaweb.commune.accounting.invoice.data.PaymentRecord createVatPaymentRecord(se.idega.idegaweb.commune.accounting.invoice.data.PaymentRecord previousPaymentRecord,com.idega.block.school.data.School school, com.idega.block.school.data.SchoolType sType,com.idega.block.school.data.SchoolYear sYear,com.idega.util.CalendarMonth month,char status,String signature) throws java.rmi.RemoteException,javax.ejb.CreateException;
