...
public interface InvoiceBusiness extends com.idega.business.IBOService
{
 ...
 public java.util.Collection findInvoiceRecordsByContract(se.idega.idegaweb.commune.accounting.childcare.data.ChildCareContract p0)throws javax.ejb.FinderException, java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.accounting.childcare.data.ChildCareContractHome getChildCareContractHome()throws java.rmi.RemoteException, java.rmi.RemoteException;
