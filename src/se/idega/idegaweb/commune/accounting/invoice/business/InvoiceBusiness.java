...
{
    int generateInvoiceCompilationPdf(se.idega.idegaweb.commune.accounting.invoice.data.InvoiceHeader invoiceHeader, String [] columnNames) throws java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.accounting.invoice.data.InvoiceRecord createInvoiceRecord(com.idega.user.data.User p0,java.lang.Integer p1,java.sql.Date p2,java.sql.Date p3,java.lang.String p4,java.lang.Integer p5,java.lang.String p6,java.lang.String p7,java.lang.Integer p8,java.lang.String p9,java.sql.Date p10,java.sql.Date p11,java.lang.Integer p12,java.lang.String p13,java.lang.Integer p14,java.lang.Integer p15,String p16, Integer p17)throws javax.ejb.CreateException, java.rmi.RemoteException;
