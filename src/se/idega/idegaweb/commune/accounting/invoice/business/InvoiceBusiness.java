...
public interface InvoiceBusiness extends com.idega.business.IBOService
{
 ...
 public se.idega.idegaweb.commune.accounting.invoice.data.InvoiceRecord createInvoiceRecord(User createdBy, Integer invoiceHeaderId, Integer placementId, Integer providerId, String ruleText, String invoiceText, String invoiceText2, String note, Date placementStartPeriod, Date placementEndPeriod, Date checkStartPeriod, Date checkEndPeriod, Integer amount, Integer vatAmount, Integer numberOfDays, Integer regSpecTypeId, Integer vatRule, String ownPosting, String doublePosting, Integer pieceAmount, String ownPaymentPosting, String doublePaymentPosting, Integer orderId)throws javax.ejb.CreateException, java.rmi.RemoteException;
