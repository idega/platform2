...
public java.util.Collection findRegularInvoicesForPeriodAndChildAndCategoryExceptType(java.sql.Date p0,java.sql.Date p1,int p2,java.lang.String p3,int p4)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((RegularInvoiceEntryBMPBean)entity).ejbFindRegularInvoicesForPeriodAndChildAndCategoryExceptType(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
