...
public java.util.Collection findRegularInvoicesForPeriodeUserCategoryAndRegSpecType(java.sql.Date p0,int p1,java.lang.String p2,int p3)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((RegularInvoiceEntryBMPBean)entity).ejbFindRegularInvoicesForPeriodeUserCategoryAndRegSpecType(p0,p1,p2,p3);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
