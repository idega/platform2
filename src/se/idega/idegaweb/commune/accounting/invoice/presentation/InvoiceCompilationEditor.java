...
public class InvoiceCompilationEditor extends AccountingBlock {
    ...
    private static final String COULD_NOT_REMOVE_INVOICE_COMPILATION_OR_RECORDS_DEFAULT = "Det gick inte att at bort fakturaunderlaget eller n�gon av dess fakturarader";
    ...
    private static final String EDIT_INVOICE_RECORD_DEFAULT = "�ndra fakturarad";
    private static final String EDIT_INVOICE_RECORD_KEY = PREFIX + "edit_invoice_record";
    private static final String EDIT_ROW_DEFAULT = "�ndra rad";
    ...
    private static final String FIRST_NAME_DEFAULT = "F�rnamn";
    ...
    private static final String INVOICE_COMPILATION_AND_RECORDS_REMOVED_DEFAULT = "Fakturaunderlaget och dess fakturarader �r nu borttagna";
    private static final String INVOICE_COMPILATION_AND_RECORDS_REMOVED_KEY = PREFIX + "invoice_compilation_and_records_removed";
    private static final String INVOICE_COMPILATION_CREATED_DEFAULT = "Fakturaunderlaget �r nu skapat";
    ...
    private static final String INVOICE_RECORD_CREATED_DEFAULT = "Fakturaraden �r nu skapad";
    ...
    private static final String INVOICE_RECORD_REMOVED_DEFAULT = "Fakturaraden �r borttagen";
    ...
    private static final String JOURNAL_ENTRY_DATE_DEFAULT = "Bokf�ringsdag";
    ...
    private static final String NOTE_DEFAULT = "Anm�rkning";
    private static final String NOTE_KEY = PREFIX + "note";
    private static final String NO_COMPILATION_FOUND_DEFAULT = "Ingen faktura hittades f�r denna v�rdnadshavare eller barn";
    ...
    private static final String REMARK_DEFAULT = "Anm�rkning";
    private static final String REMARK_KEY = PREFIX + "remark";
    private static final String RULE_TEXT_KEY = PREFIX + "rule_text";
    private static final String SEARCH_DEFAULT = "S�k";
    private static final String SEARCH_INVOICE_RECEIVER_DEFAULT = "S�k efter fakturamottagare";
    ...
    private static final String TOO_MANY_RESULTS_DEFAULT = "F�r m�nga s�ktr�ffar - f�rs�k att begr�nsa dina s�kkriterier";
    ...
    private static final String INVOICE_RECORD_UPDATED_DEFAULT = "Fakturaraden �r nu uppdaterad";
