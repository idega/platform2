...
public class ChildCareContractHomeImpl extends IDOFactory implements
    ...
    public Collection findByChild(int childID, int resultSize, int startIndex)
            throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ChildCareContractBMPBean) entity)
                .ejbFindByChild(childID, resultSize, startIndex);
        this.idoCheckInPooledEntity(entity);
        return this.getEntityCollectionForPrimaryKeys(ids);
    }
    ...
    public ChildCareContract findValidContractByPlacement(
            SchoolClassMember member, Date date) throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        Object pk = ((ChildCareContractBMPBean) entity)
                .ejbFindValidContractByPlacement(member, date);
        this.idoCheckInPooledEntity(entity);
        return this.findByPrimaryKey(pk);
    }
    ...
    public ChildCareContract findLatestNotByApplication(int applicationID,
            Date startDate) throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        Object pk = ((ChildCareContractBMPBean) entity)
                .ejbFindLatestNotByApplication(applicationID, startDate);
        this.idoCheckInPooledEntity(entity);
        return this.findByPrimaryKey(pk);
    }
    ...
    public ChildCareContract findContractByApplicationAndDate(
            int applicationID, Date date) throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        Object pk = ((ChildCareContractBMPBean) entity)
                .ejbFindContractByApplicationAndDate(applicationID, date);
        this.idoCheckInPooledEntity(entity);
        return this.findByPrimaryKey(pk);
    }
    ...
    public Collection findChangedSinceDate(Date date) throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ChildCareContractBMPBean) entity)
                .ejbFindChangedSinceDate(date);
        this.idoCheckInPooledEntity(entity);
        return this.getEntityCollectionForPrimaryKeys(ids);
    }

    public Collection findChangedBetween(Date from, Date to)
            throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ChildCareContractBMPBean) entity)
                .ejbFindChangedBetween(from, to);
        this.idoCheckInPooledEntity(entity);
        return this.getEntityCollectionForPrimaryKeys(ids);
    }
    ...
    public ChildCareContract findLatestBySchoolClassMember(
            SchoolClassMember placement) throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        Object pk = ((ChildCareContractBMPBean) entity)
                .ejbFindLatestBySchoolClassMember(placement);
        this.idoCheckInPooledEntity(entity);
        return this.findByPrimaryKey(pk);
    }
    ...
    public int getCountBySchoolClassMember(SchoolClassMember member)
            throws IDOException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        int theReturn = ((ChildCareContractBMPBean) entity)
                .ejbHomeGetCountBySchoolClassMember(member);
        this.idoCheckInPooledEntity(entity);
        return theReturn;
    }

    public Collection findAllByCareTimeAndDates(String careTime,
            Date startingBefore, Date fromBirthDate, Date toBirthDate)
            throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ChildCareContractBMPBean) entity)
                .ejbFindAllByCareTimeAndDates(careTime, startingBefore,
                        fromBirthDate, toBirthDate);
        this.idoCheckInPooledEntity(entity);
        return this.getEntityCollectionForPrimaryKeys(ids);
    }

    public Collection findAllByProviderAndClassMemberDateRange(
            Integer schoolId, Date startFrom, Date startTo, Date endFrom,
            Date endTo) throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ChildCareContractBMPBean) entity)
                .ejbFindAllByProviderAndClassMemberDateRange(schoolId,
