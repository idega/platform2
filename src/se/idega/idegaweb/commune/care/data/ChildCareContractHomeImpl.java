...
public class ChildCareContractHomeImpl extends IDOFactory implements ChildCareContractHome {
	...
	public Collection findFutureContractsByApplication(int applicationID, Date date) throws FinderException {
		com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
		java.util.Collection ids = ((ChildCareContractBMPBean) entity).ejbFindFutureContractsByApplication(applicationID,
				date);
		this.idoCheckInPooledEntity(entity);
		return this.getEntityCollectionForPrimaryKeys(ids);
	}
	...
	public int getFutureContractsCountByApplication(int applicationID, Date date) throws IDOException {
		com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
		int theReturn = ((ChildCareContractBMPBean) entity).ejbHomeGetFutureContractsCountByApplication(applicationID, date);
		this.idoCheckInPooledEntity(entity);
		return theReturn;
	}
	...
	public int getContractsCountByDateRangeAndProvider(Date startDate, Date endDate, int providerID) throws IDOException {
		com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
