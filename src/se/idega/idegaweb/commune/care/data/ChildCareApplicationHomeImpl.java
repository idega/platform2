...
public class ChildCareApplicationHomeImpl extends IDOFactory implements
    ...
    public Collection findAllCasesByProviderAndNotInStatus(int providerId,
            String[] caseStatus, int numberOfEntries, int startingEntry,
            int orderBy) throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ChildCareApplicationBMPBean) entity)
                .ejbFindAllCasesByProviderAndNotInStatus(providerId,
                        caseStatus, numberOfEntries, startingEntry, orderBy);
        this.idoCheckInPooledEntity(entity);
        return this.getEntityCollectionForPrimaryKeys(ids);
    }
    ...
    public Collection findApplicationsByProviderAndApplicationStatusAndTerminatedDate(
            int providerID, String[] applicationStatuses, Date terminatedDate)
            throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        java.util.Collection ids = ((ChildCareApplicationBMPBean) entity)
                .ejbFindApplicationsByProviderAndApplicationStatusAndTerminatedDate(
    ...
    public int getNumberOfApplicationsForChildInStatusNotWithProvider(
            int childID, int providerID, Date date, String[] caseStatus)
            throws IDOException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        int theReturn = ((ChildCareApplicationBMPBean) entity)
                .ejbHomeGetNumberOfApplicationsForChildInStatusNotWithProvider(
                        childID, providerID, date, caseStatus);
        this.idoCheckInPooledEntity(entity);
        return theReturn;
    }

    public ChildCareApplication findFutureApplicationForChildInStatusNotWithProvider(
            int childID, int providerID, Date date, String[] caseStatus)
            throws FinderException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        Object pk = ((ChildCareApplicationBMPBean) entity)
                .ejbFindFutureApplicationForChildInStatusNotWithProvider(
                        childID, providerID, date, caseStatus);
        this.idoCheckInPooledEntity(entity);
        return this.findByPrimaryKey(pk);
    }
    ...
    public int getPositionInQueue(Date queueDate, int providerID,
            String[] caseStatus, int orderBy) throws IDOException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        int theReturn = ((ChildCareApplicationBMPBean) entity)
                .ejbHomeGetPositionInQueue(queueDate, providerID, caseStatus,
                        orderBy);
    ...
    public int getPositionInQueue(Date queueDate, int providerID,
            String applicationStatus, int orderBy) throws IDOException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        int theReturn = ((ChildCareApplicationBMPBean) entity)
                .ejbHomeGetPositionInQueue(queueDate, providerID,
    ...
    public int getPositionInQueueByDate(int queueOrder, Date queueDate,
            int providerID, String[] caseStatus, int orderBy)
            throws IDOException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        int theReturn = ((ChildCareApplicationBMPBean) entity)
                .ejbHomeGetPositionInQueueByDate(queueOrder, queueDate,
    ...
    public int getPositionInQueueByDate(int queueOrder, Date queueDate,
            int providerID, String applicationStatus, int orderBy)
            throws IDOException {
        com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
        int theReturn = ((ChildCareApplicationBMPBean) entity)
                .ejbHomeGetPositionInQueueByDate(queueOrder, queueDate,
