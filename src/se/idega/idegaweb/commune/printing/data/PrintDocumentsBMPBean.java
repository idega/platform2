 ...
 * @version 1.0
 */
public class PrintDocumentsBMPBean extends GenericEntity implements PrintDocuments
{
	...
	{
		return (ICFile) this.getColumnValue(COLUMN_DOCUMENT); //Replace this later
	}
	...
	protected IDOQuery idoQueryGetSelectWithType(String type){
	...
	/**
	 * Sets the ifPrinted.
	 * @param ifPrinted The ifPrinted to set
	 */
