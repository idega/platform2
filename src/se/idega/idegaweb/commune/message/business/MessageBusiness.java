...
public interface MessageBusiness extends com.idega.business.IBOService
{
 ...
 public se.idega.idegaweb.commune.message.data.Message getUserMessage(int p0)throws java.rmi.RemoteException,javax.ejb.FinderException, java.rmi.RemoteException;
