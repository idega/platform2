/*
 * $Id: AfterSchoolChoiceBMPBean.java,v 1.1 2003/09/16 12:46:16 aron Exp $
 *
...
*/
	...
	*/
	...
	public Integer ejbFindNewestApplication(Integer providerID, Date date) throws FinderException {
		IDOQuery sql = idoQuery();
	...
	public Integer ejbFindOldestApplication(Integer providerID, Date date) throws FinderException {
		IDOQuery sql = idoQuery();
		sql.appendSelectAllFrom(this).appendWhereEquals(PROVIDER_ID, providerID);
	...
	public Collection ejbFindApplicationsByProviderAndDate(Integer providerID, Date date) throws FinderException {
		IDOQuery sql = idoQuery();
		sql.appendSelectAllFrom(this).appendWhereEquals(PROVIDER_ID, providerID);
	...
	public int ejbHomeGetPositionInQueue(Date queueDate, Integer providerID, String[] caseStatus) throws IDOException {
		IDOQuery sql = idoQuery();
		sql.append("select count(c." + CHILD_ID + ") from ").append(ENTITY_NAME).append(" c , proc_case p");
		sql.appendWhereEquals("c." + getIDColumnName(), "p.proc_case_id");
		sql.appendAndEquals("c." + PROVIDER_ID, providerID);
	...
	public int ejbHomeGetPositionInQueueByDate(Integer queueOrder, Date queueDate, Integer providerID, String[] caseStatus)
		throws IDOException {
		IDOQuery sql = idoQuery();
		sql.append("select count(c." + CHILD_ID + ") from ").append(ENTITY_NAME).append(" c , proc_case p");
		sql.appendWhereEquals("c." + getIDColumnName(), "p.proc_case_id");
	...
	public int ejbHomeGetQueueSizeNotInStatus(Integer providerID, String caseStatus[]) throws IDOException {
		IDOQuery sql = idoQuery();
		sql.append("select count(c." + CHILD_ID + ") from ").append(ENTITY_NAME).append(" c , proc_case p");
		sql.appendWhereEquals("c." + getIDColumnName(), "p.proc_case_id");
		sql.appendAndEquals("c." + PROVIDER_ID, providerID);
	...
	public int ejbHomeGetQueueSizeInStatus(Integer providerID, String caseStatus) throws IDOException {
		IDOQuery sql = idoQuery();
		sql.append("select count(c." + CHILD_ID + ") from ").append(ENTITY_NAME).append(" c , proc_case p");
		sql.appendWhereEquals("c." + getIDColumnName(), "p.proc_case_id");
		sql.appendAndEquals("c." + PROVIDER_ID, providerID);
	...
	public int ejbHomeGetQueueSizeByAreaNotInStatus(Integer areaID, String caseStatus[]) throws IDOException {
		IDOQuery sql = idoQuery();
		sql.append("select count(c." + CHILD_ID + ") from ").append(ENTITY_NAME).append(
			" c , proc_case p, sch_school s");
		sql.appendWhereEquals("c." + getIDColumnName(), "p.proc_case_id");
	...
	public int ejbHomeGetQueueSizeByAreaInStatus(Integer areaID, String caseStatus) throws IDOException {
		IDOQuery sql = idoQuery();
		sql.append("select count(c." + CHILD_ID + ") from ").append(ENTITY_NAME).append(
			" c , proc_case p, sch_school s");
		sql.appendWhereEquals("c." + getIDColumnName(), "p.proc_case_id");
