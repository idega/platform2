...
public ChildCareApplication findActiveApplicationByChildAndStatus(int p0,java.lang.String[] p1)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	Object pk = ((ChildCareApplicationBMPBean)entity).ejbFindActiveApplicationByChildAndStatus(p0,p1);
	this.idoCheckInPooledEntity(entity);
	return this.findByPrimaryKey(pk);
}
...
public java.util.Collection findAllByAreaAndApplicationStatus(java.lang.Object p0,java.lang.String[] p1,java.lang.String p2,java.sql.Date p3,java.sql.Date p4,boolean p5)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindAllByAreaAndApplicationStatus(p0,p1,p2,p3,p4,p5);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public ChildCareApplication findApplicationByChildAndApplicationStatus(int p0,java.lang.String[] p1)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	Object pk = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationByChildAndApplicationStatus(p0,p1);
	this.idoCheckInPooledEntity(entity);
	return this.findByPrimaryKey(pk);
}
...
public java.util.Collection findApplicationByChildAndInStatus(int p0,java.lang.String[] p1,java.lang.String p2)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationByChildAndInStatus(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationByChildAndNotInStatus(int p0,java.lang.String[] p1,java.lang.String p2)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationByChildAndNotInStatus(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public ChildCareApplication findApplicationByChildAndProviderAndStatus(int p0,int p1,java.lang.String[] p2)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	Object pk = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationByChildAndProviderAndStatus(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return this.findByPrimaryKey(pk);
}
...
public java.util.Collection findApplicationsBeforeLastReplyDate(java.sql.Date p0,java.lang.String[] p1)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsBeforeLastReplyDate(p0,p1);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}

public java.util.Collection findApplicationsByChildAndApplicationStatus(int p0,java.lang.String[] p1)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsByChildAndApplicationStatus(p0,p1);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationsByProviderAndApplicationStatus(int p0,java.lang.String[] p1,java.lang.String p2,int p3,int p4)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsByProviderAndApplicationStatus(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationsByProviderAndApplicationStatus(int p0,java.lang.String[] p1)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsByProviderAndApplicationStatus(p0,p1);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationsByProviderAndApplicationStatus(int p0,java.lang.String[] p1,java.lang.String p2)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsByProviderAndApplicationStatus(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationsByProviderAndBeforeDate(int p0,java.sql.Date p1,java.lang.String[] p2)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsByProviderAndBeforeDate(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationsByProviderAndStatus(int p0,java.lang.String[] p1,java.lang.String p2)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsByProviderAndStatus(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationsByProviderAndStatus(int p0,java.lang.String[] p1,java.lang.String p2,int p3,int p4)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsByProviderAndStatus(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationsByProviderAndStatus(java.lang.Integer p0,java.lang.String[] p1,java.sql.Date p2,java.sql.Date p3,java.sql.Date p4,java.sql.Date p5)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsByProviderAndStatus(p0,p1,p2,p3,p4,p5);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public java.util.Collection findApplicationsInSchoolAreaByStatus(int p0,java.lang.String[] p1,int p2)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	java.util.Collection ids = ((ChildCareApplicationBMPBean)entity).ejbFindApplicationsInSchoolAreaByStatus(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return this.getEntityCollectionForPrimaryKeys(ids);
}
...
public int getBruttoQueueByProviderAndChoiceNumber(int p0,int p1,java.lang.String p2,java.sql.Date p3,java.sql.Date p4)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetBruttoQueueByProviderAndChoiceNumber(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getBruttoQueueSizeInStatus(int p0,java.lang.String[] p1,java.sql.Date p2,java.sql.Date p3,boolean p4)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetBruttoQueueSizeInStatus(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getNettoQueueByProviderAndChoiceNumber(int p0,int p1,java.lang.String p2,java.sql.Date p3,java.sql.Date p4)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetNettoQueueByProviderAndChoiceNumber(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getNettoQueueSizeInStatus(int p0,java.lang.String p1,java.sql.Date p2,java.sql.Date p3,boolean p4)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetNettoQueueSizeInStatus(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getNumberOfApplicationsByStatus(int p0,java.lang.String[] p1)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetNumberOfApplicationsByStatus(p0,p1);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getNumberOfApplicationsForChild(int p0,java.lang.String p1,java.lang.String p2)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetNumberOfApplicationsForChild(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getNumberOfApplicationsForChildInStatus(int p0,java.lang.String[] p1,java.lang.String p2)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetNumberOfApplicationsForChildInStatus(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getNumberOfApplicationsForChildNotInStatus(int p0,java.lang.String[] p1)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetNumberOfApplicationsForChildNotInStatus(p0,p1);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getNumberOfApplicationsForChildNotInStatus(int p0,java.lang.String[] p1,java.lang.String p2)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetNumberOfApplicationsForChildNotInStatus(p0,p1,p2);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getQueueByProviderAndChoiceNumber(int p0,int p1,java.lang.String p2,java.sql.Date p3,java.sql.Date p4)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetQueueByProviderAndChoiceNumber(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
...
public int getQueueSizeInStatus(int p0,java.lang.String[] p1,java.sql.Date p2,java.sql.Date p3,boolean p4)throws com.idega.data.IDOException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
	int theReturn = ((ChildCareApplicationBMPBean)entity).ejbHomeGetQueueSizeInStatus(p0,p1,p2,p3,p4);
	this.idoCheckInPooledEntity(entity);
	return theReturn;
}
