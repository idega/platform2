...
public interface ChildCareBusiness extends com.idega.business.IBOService, CaseBusiness
{
 ...
 public void alterValidFromDate(int p0,java.sql.Date p1,java.util.Locale p2,com.idega.user.data.User p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public void alterValidFromDate(se.idega.idegaweb.commune.childcare.data.ChildCareApplication p0,java.sql.Date p1,java.util.Locale p2,com.idega.user.data.User p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public boolean canCancelContract(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public void changePlacingDate(int p0,java.sql.Date p1,java.lang.String p2)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.childcare.data.ChildCareApplication getActiveApplicationByChild(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.childcare.data.ChildCareApplication getActivePlacement(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.childcare.data.ChildCareApplication getApplication(int p0,int p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.childcare.data.ChildCareQueueHome getChildCareQueueHome()throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.childcare.data.ChildCareContract getLatestContract(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.childcare.data.ChildCareContract getLatestTerminatedContract(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.childcare.data.ChildCareApplication getNewestApplication(int p0,java.sql.Date p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public int getPositionInQueue(se.idega.idegaweb.commune.childcare.data.ChildCareQueue p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Map getProviderAreaMap(java.util.Collection p0,java.util.Locale p1,java.lang.String p2,boolean p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Collection getQueueChoices(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public se.idega.idegaweb.commune.childcare.data.ChildCareContract getValidContract(int p0,java.sql.Date p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.childcare.data.ChildCareContract getValidContract(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.childcare.data.ChildCareContract getValidContractByChild(int p0,java.sql.Date p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public se.idega.idegaweb.commune.childcare.data.ChildCareContract getValidContractByChild(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public boolean placeApplication(int p0,java.lang.String p1,java.lang.String p2,int p3,int p4,int p5,com.idega.user.data.User p6,java.util.Locale p7)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public void removeFromProvider(int p0,int p1,java.sql.Timestamp p2,boolean p3,java.lang.String p4) throws java.rmi.RemoteException;
 ...
 public void removeFutureContracts(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public void removeFutureContracts(int p0,java.sql.Date p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public boolean retractOffer(int p0,java.lang.String p1,java.lang.String p2,com.idega.user.data.User p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
