...
public interface ChildCareBusiness extends IBOService, CaseBusiness {
	 ...
	 */
	public boolean placeApplication(int applicationID, String subject, String body, String childCareTime, int groupID, int schoolTypeID, int employmentTypeID, User user, Locale locale) throws java.rmi.RemoteException;
	 ...
	 */
	public boolean acceptApplication(ChildCareApplication application, IWTimestamp validUntil, String subject, String message, User user) throws java.rmi.RemoteException;
	 ...
	 * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#acceptApplication
	 */
	public boolean acceptApplication(int applicationId, IWTimestamp validUntil, String subject, String message, User user) throws java.rmi.RemoteException;
	 ...
	 * malin
	 */
	public Collection getAcceptedApplicationsByProvider(int providerID, Date date, boolean showNotYetActive, int schoolClassID, int sort) throws java.rmi.RemoteException;
	 ...
	 * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#assignContractToApplication
	 */
	public boolean assignContractToApplication(int applicationID, int archiveID, String childCareTime, IWTimestamp validFrom, int employmentTypeID, User user, Locale locale, boolean changeStatus, boolean createNewStudent, int schoolTypeId, int schoolClassId) throws java.rmi.RemoteException;
