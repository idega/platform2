...
public interface ChildCareBusiness extends IBOService, CaseBusiness,
        EmploymentTypeFinderBusiness, ManagementTypeFinderBusiness {
    /**
    ...
    public void updatePrognosis(int providerID, int threeMonthsPrognosis,
            ...
            int providerCapacity, int vacancies, String providerComments)
            throws java.rmi.RemoteException;
     ...
     */
    public Collection getTerminatedApplicationsByProviderAndApplicationStatus(
            int providerID, String applicationStatus)
            throws java.rmi.RemoteException;
     ...
     */
    public Collection getApplicationsInQueueBeforeDate(int providerID,
            Date beforeDate) throws FinderException, java.rmi.RemoteException;
    ...
    public boolean placeApplication(int applicationID, String subject,
            String body, String childCareTime, int groupID, int schoolTypeID,
            int employmentTypeID, IWTimestamp terminationDate, User user,
     ...
     */
    public void alterValidFromDate(int applicationID, Date newDate,
            int employmentTypeID, int schoolTypeID, int schoolClassID,
            Locale locale, User user) throws RemoteException,
     ...
     */
    public void alterValidFromDate(ChildCareApplication application,
            Date newDate, int employmentTypeID, int schoolTypeID,
            int schoolClassID, Locale locale, User user)
            throws RemoteException, NoPlacementFoundException;

    /**
     * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#alterContract
     */
    public boolean alterContract(int childcareContractID, String careTime,
    ...
    public boolean alterContract(ChildCareContract childcareContract,
            String careTime, Date fromDate, Date endDate, Locale locale,
     ...
     * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#moveToGroup
     */
    public void moveToGroup(int placementID, int schoolClassID, User performer)
    ...
    public void removeFromProvider(int placementID, Timestamp date,
            boolean parentalLeave, String message, User performer)
            throws java.rmi.RemoteException;

    /**
     * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#getLatestPlacement
     */
    public SchoolClassMember getLatestPlacement(int childID, int providerID)
     ...
     */
    public void createCancelForm(ChildCareApplication application,
            Date cancelDate, Locale locale) throws java.rmi.RemoteException;
     ...
     */
    public ICFile assignContractToApplication(int applicationID,
            int oldArchiveID, String childCareTime, IWTimestamp validFrom,
     ...
     */
    public boolean isOnlyGroupChange(int applicationId, String careTime,
            int employmentTypeID, Date validFrom, int schoolTypeId)
            throws java.rmi.RemoteException;

    /**
     * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#isGroupChange
     */
    public boolean isGroupChange(int applicationId, Date validFrom,
     ...
     */
    public void changeGroup(int applicationId, Date validFrom,
            int schoolClassId, User user) throws java.rmi.RemoteException;

    /**
     * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#assignContractToApplication
     */
    public ICFile assignContractToApplication(int applicationID, int archiveID,
            String childCareTime, IWTimestamp validFrom, int employmentTypeID,
            User user, Locale locale, boolean changeStatus,
            boolean createNewStudent, int schoolTypeId, int schoolClassId)
            throws java.rmi.RemoteException;
     ...
     */
    public ChildCareApplication getApplicationForChildAndProviderinStatus(
            int childID, int providerID) throws java.rmi.RemoteException;

    /**
     * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#getApplicationForChildAndProviderinStatus
     */
    public ChildCareApplication getApplicationForChildAndProviderinStatus(
            int childID, int providerID, String[] statuses)
            throws java.rmi.RemoteException;
     ...
     */
    public Collection getLatestContractsForChild(int childID,
            int maxNumberOfContracts) throws java.rmi.RemoteException;
     ...
     */
    public ChildCareContract getValidContractForChild(int childID,
            Date validDate) throws java.rmi.RemoteException;
     ...
     */
    public ChildCareContract getValidContractByPlacement(
            SchoolClassMember member) throws java.rmi.RemoteException;

    /**
     * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#getValidContractByPlacement
     */
    public ChildCareContract getValidContractByPlacement(
            SchoolClassMember member, Date validDate)
            throws java.rmi.RemoteException;
     ...
     */
    public void removeLatestFutureContract(int applicationID,
            Date earliestAllowedRemoveDate, User performer)
            throws java.rmi.RemoteException;
     ...
     */
    public boolean hasFutureActivePlacementsNotWithProvider(int childID,
            int providerID, Date date) throws java.rmi.RemoteException;

    /**
     * @see se.idega.idegaweb.commune.childcare.business.ChildCareBusinessBean#getFirstFuturePlacementNotWithProvider
     */
    public ChildCareApplication getFirstFuturePlacementNotWithProvider(
            int childID, int providerID, Date date)
            throws java.rmi.RemoteException;
     ...
     */
    public ChildCareContract getContractByApplicationAndDate(int applicationID,
            Date date) throws java.rmi.RemoteException;
    ...
    public boolean importChildToProvider(int applicationID, int childID,
            int providerID, int groupID, String careTime, int employmentTypeID,
     ...
     */
    public Collection getProviderStatsBeforeUpdate(Locale sortLocale)
            throws FinderException, java.rmi.RemoteException;
     ...
     */
    public boolean setUserAsDeceased(Integer userID, java.util.Date deceasedDate)
            throws RemoteException;
     ...
     */
    public void sendMessageToParents(ChildCareApplication application,
            String subject, String body, boolean alwaysSendLetter)
            throws java.rmi.RemoteException;
     ...
     */
    public void sendMessageToParents(ChildCareApplication application,
            String subject, String body, String letterBody,
    ...
    public void sendMessageToParents(ChildCareApplication application,
            String subject, String body, String letterBody,
            boolean alwaysSendLetter, boolean sendToOtherParent)
            throws java.rmi.RemoteException;
     ...
     */
    public School getFirstProviderForUser(User user) throws FinderException,
            RemoteException;
     ...
     */
    public Map getSchoolTypeClassMap(Collection schoolTypes, int schoolID,
            int seasonID, Boolean showSubGroups, Boolean showNonSeasonGroups,
            String noSchoolClassFoundEntry) throws java.rmi.RemoteException;
     ...
     */
    public Collection changeAllContractsInRange(String fromCareTime,
