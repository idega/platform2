...
public interface ChildCareBusiness extends com.idega.business.IBOService
{
 ...
 public boolean assignApplication(int p0,int p1,java.lang.String p2,java.lang.String p3) throws java.rmi.RemoteException;
 public java.util.Collection getUnsignedApplicationsByProvider(int p0) throws java.rmi.RemoteException;
 public boolean assignContractToApplication(java.lang.String[] p0,int p1) throws java.rmi.RemoteException;
 public boolean assignContractToApplication(int p0,int p1) throws java.rmi.RemoteException;
 public boolean assignApplication(java.lang.String[] p0,int p1,java.lang.String p2,java.lang.String p3) throws java.rmi.RemoteException;
}
