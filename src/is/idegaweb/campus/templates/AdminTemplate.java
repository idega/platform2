/*
 * $Id: AdminTemplate.java,v 1.1 2001/06/28 10:36:02 aron Exp $
 *
...
public abstract class AdminTemplate extends JSPModule implements JspPage{
  ...
  private boolean bRightTable = false;
  ...
  public void setRightTable(boolean right){
    this.bRightTable = right;
  }
  ...
  public void initMainTable(){
    ...
    MainTable.setVerticalAlignment(cols,1,"top");
  ...
  public void initTitleTable(){
    ...
    TitleTable.setAlignment(2,1,"left");
