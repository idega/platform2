 ...
 * Schema.
 * $Id: SendingarType.java,v 1.1 2005/03/15 11:35:09 birna Exp $
 */
...
public class SendingarType implements java.io.Serializable {
     ...
     * Field _snigill
     */
    private is.idega.block.finance.business.li.sign_in_answer.types.ErTilType _snigill;
    ...
    public SendingarType() {
        super();
    } //-- is.idega.block.finance.business.li.sign_in_answer.SendingarType()
     ...
     */
    public is.idega.block.finance.business.li.sign_in_answer.types.ErTilType getSnigill()
    {
        return this._snigill;
    } //-- is.idega.block.finance.business.li.sign_in_answer.types.ErTilType getSnigill() 
     ...
     */
    public void setSnigill(is.idega.block.finance.business.li.sign_in_answer.types.ErTilType snigill)
    {
        this._snigill = snigill;
    } //-- void setSnigill(is.idega.block.finance.business.li.sign_in_answer.types.ErTilType) 
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (is.idega.block.finance.business.li.sign_in_answer.SendingarType) Unmarshaller.unmarshal(is.idega.block.finance.business.li.sign_in_answer.SendingarType.class, reader);
