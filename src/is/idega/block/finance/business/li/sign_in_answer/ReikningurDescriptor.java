 ...
 * Schema.
 * $Id: ReikningurDescriptor.java,v 1.1 2005/03/15 11:35:09 birna Exp $
 */
...
public class ReikningurDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReikningurDescriptor() {
        ...
        desc.setValidator(fieldValidator);
    } //-- is.idega.block.finance.business.li.sign_in_answer.ReikningurDescriptor()
    ...
    {
        return is.idega.block.finance.business.li.sign_in_answer.Reikningur.class;
