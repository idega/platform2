 ...
 * Schema.
 * $Id: LI_IK_krafa_typeDescriptor.java,v 1.1 2005/03/15 11:35:06 birna Exp $
 */
...
public class LI_IK_krafa_typeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LI_IK_krafa_typeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
    } //-- is.idega.block.finance.business.li.claims.LI_IK_krafa_typeDescriptor()
    ...
    {
        return is.idega.block.finance.business.li.claims.LI_IK_krafa_type.class;
