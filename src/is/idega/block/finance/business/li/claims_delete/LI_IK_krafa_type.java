 ...
 * Schema.
 * $Id: LI_IK_krafa_type.java,v 1.1 2005/03/15 11:35:08 birna Exp $
 */
...
public class LI_IK_krafa_type implements java.io.Serializable {
     ...
     * Field _astand
     */
    private is.idega.block.finance.business.li.claims_delete.types.LI_IK_astand_type _astand;
    ...
    public LI_IK_krafa_type() {
        super();
    } //-- is.idega.block.finance.business.li.claims_delete.LI_IK_krafa_type()
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.Afslattur getAfslattur() 
     ...
     */
    public is.idega.block.finance.business.li.claims_delete.types.LI_IK_astand_type getAstand()
    {
        return this._astand;
    } //-- is.idega.block.finance.business.li.claims_delete.types.LI_IK_astand_type getAstand() 
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.Birting getBirting() 
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.Birtingarkerfi getBirtingarkerfi() 
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.Drattarvextir getDrattarvextir() 
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.Gengiskrafa getGengiskrafa() 
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.types.LI_IK_greidsluregla_type getGreidsluregla() 
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.types.LI_IK_innborgunarregla_type getInnborgunarregla() 
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.Upphaed getUpphaed() 
    ...
    } //-- is.idega.block.finance.business.li.claims_delete.Vanskilagjald getVanskilagjald() 
    ...
    } //-- void setAfslattur(is.idega.block.finance.business.li.claims_delete.Afslattur) 
     ...
     */
    public void setAstand(is.idega.block.finance.business.li.claims_delete.types.LI_IK_astand_type astand)
    {
        this._astand = astand;
    } //-- void setAstand(is.idega.block.finance.business.li.claims_delete.types.LI_IK_astand_type) 
    ...
    } //-- void setBirting(is.idega.block.finance.business.li.claims_delete.Birting) 
    ...
    } //-- void setBirtingarkerfi(is.idega.block.finance.business.li.claims_delete.Birtingarkerfi) 
    ...
    } //-- void setDrattarvextir(is.idega.block.finance.business.li.claims_delete.Drattarvextir) 
    ...
    } //-- void setGengiskrafa(is.idega.block.finance.business.li.claims_delete.Gengiskrafa) 
    ...
    } //-- void setGreidsluregla(is.idega.block.finance.business.li.claims_delete.types.LI_IK_greidsluregla_type) 
    ...
    } //-- void setInnborgunarregla(is.idega.block.finance.business.li.claims_delete.types.LI_IK_innborgunarregla_type) 
    ...
    } //-- void setUpphaed(is.idega.block.finance.business.li.claims_delete.Upphaed) 
    ...
    } //-- void setVanskilagjald(is.idega.block.finance.business.li.claims_delete.Vanskilagjald) 
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (is.idega.block.finance.business.li.claims_delete.LI_IK_krafa_type) Unmarshaller.unmarshal(is.idega.block.finance.business.li.claims_delete.LI_IK_krafa_type.class, reader);
