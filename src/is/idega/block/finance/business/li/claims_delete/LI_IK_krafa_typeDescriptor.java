 ...
 * Schema.
 * $Id: LI_IK_krafa_typeDescriptor.java,v 1.1 2005/03/15 11:35:08 birna Exp $
 */
...
/**
 * Class LI_IK_krafa_typeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2005/03/15 11:35:08 $
 */
public class LI_IK_krafa_typeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LI_IK_krafa_typeDescriptor() {
        super();
        xmlName = "LI_IK_krafa_type";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                LI_IK_krafa_type target = (LI_IK_krafa_type) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _aunnin_kostnadur
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Integer.TYPE, "_aunnin_kostnadur", "aunnin_kostnadur", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                LI_IK_krafa_type target = (LI_IK_krafa_type) object;
                if(!target.hasAunnin_kostnadur())
                    return null;
                return new java.lang.Integer(target.getAunnin_kostnadur());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setAunnin_kostnadur( ((java.lang.Integer)value).intValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _aunnin_kostnadur
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            IntegerValidator typeValidator = new IntegerValidator();
        ...
        desc.setValidator(fieldValidator);
        //-- _astand
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(is.idega.block.finance.business.li.claims_delete.types.LI_IK_astand_type.class, "_astand", "astand", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LI_IK_krafa_type target = (LI_IK_krafa_type) object;
                    target.setAstand( (is.idega.block.finance.business.li.claims_delete.types.LI_IK_astand_type) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(is.idega.block.finance.business.li.claims_delete.types.LI_IK_astand_type.class, handler));
        desc.setImmutable(true);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
    } //-- is.idega.block.finance.business.li.claims_delete.LI_IK_krafa_typeDescriptor()
    ...
    {
        return is.idega.block.finance.business.li.claims_delete.LI_IK_krafa_type.class;
