...
public class TegundKrofuskra implements java.io.Serializable {
    ...
    public static TegundKrofuskra fromValue(java.lang.String value)
        ...
        TegundKrofuskra enumeration = (TegundKrofuskra)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TegundKrofuskra.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.isb.is", "TegundKrofuskra"));
    }
    /**
