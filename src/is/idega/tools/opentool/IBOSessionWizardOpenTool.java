...
public class IBOSessionWizardOpenTool extends EJBWizardOpenTool {

  public IBOSessionWizardOpenTool() {
  }

    public EJBWizard getEJBWizardInstance(String className){
      EJBWizard instance = new IBOSessionWizard(className);
      return instance;
    }

  public Class getEJBWizardClass(){
    return is.idega.tools.IBOSessionWizard.class;
  }
  ...
  public Action getContextAction(Browser b,Node[] nodes) {
    ...
    return new EditorAction(b,nodes,"[IBOSession] Update EJB classes");
  }
