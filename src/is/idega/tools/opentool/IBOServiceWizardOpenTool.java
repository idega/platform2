...
public class IBOServiceWizardOpenTool extends EJBWizardOpenTool {

  public IBOServiceWizardOpenTool() {
  }

    public EJBWizard getEJBWizardInstance(String className){
      EJBWizard instance = new IBOServiceWizard(className);
      return instance;
    }

  public Class getEJBWizardClass(){
    return is.idega.tools.IBOServiceWizard.class;
  }
  ...
  public Action getContextAction(Browser b,Node[] nodes) {
    ...
    return new EditorAction(b,nodes,"[IBOService] Update EJB classes");
  }
