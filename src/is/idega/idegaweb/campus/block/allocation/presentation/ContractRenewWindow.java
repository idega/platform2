  ...
  */
  ...
  private void init(IWContext iwc){
   ...
   if(iContractId > 0 && !save){
      ...
      lastDate = d!=null?new idegaTimestamp(d):new idegaTimestamp();
      }
    ...
    try{
      ...
      if(newContracts ==null || newContracts.isEmpty()){
        ...
        if(contractUser !=null){
          ...
          idegaTimestamp[] stamps = ContractBusiness.getContractStampsForApartment(eContract.getApartmentId().intValue());
