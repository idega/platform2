 ...
 * $Id: CampusApplicationWriter.java,v 1.3 2002/04/06 19:11:13 tryggvil Exp $
  ...
  public static boolean writePDF(List listOfCampusApplicationHolders,IWResourceBundle iwrb,String realpath){
    ...
    try {
        ...
        for (int i = 0; i < len; i++) {
          ...
          String studybegin = CAH.getCampusApplication().getSpouseStudyBeginMonth()+" "+CAH.getCampusApplication().getSpouseStudyBeginYear();
          ...
          String studyend= CAH.getCampusApplication().getSpouseStudyEndMonth()+" "+CAH.getCampusApplication().getSpouseStudyEndYear();
          ...
          studybegin = CAH.getCampusApplication().getStudyBeginMonth()+" "+CAH.getCampusApplication().getStudyBeginYear();
          ...
          studyend= CAH.getCampusApplication().getStudyEndMonth()+" "+CAH.getCampusApplication().getStudyEndYear();
          ...
          if(size > 4){
            ...
            for (int j = 4; j < size; j++) {
              ...
              datatable.addCell("");datatable.addCell("");
