/*
 * $Id: CampusApplicationFormHelper.java,v 1.10 2002/05/02 01:44:57 palli Exp $
 *
      ...
      if ( e_mail != null ) {
        if ( e_mail.length() > 0 ) {
          try {
            ...
            SendMail.send("postmaster@studentagardar.is",receiver,"",null,"mail.idega.is","Umsókn skráð",body);
          }
          catch (Exception ex) {
            ex.printStackTrace();
          }
