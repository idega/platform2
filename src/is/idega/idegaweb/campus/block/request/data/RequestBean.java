/*
 * $Id: RequestBean.java,v 1.1 2002/02/21 00:22:02 palli Exp $
 *
 ...
 * @version 1.0
 */
public class RequestBean extends GenericEntity implements Request{
  ...
  public RequestBean(int id) throws SQLException {
    super(id);
  }
