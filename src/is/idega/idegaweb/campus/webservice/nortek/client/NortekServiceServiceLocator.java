...
public class NortekServiceServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.campus.webservice.nortek.client.NortekServiceService {
    ...
    private java.lang.String NortekService_address = "http://campusdemo.idega.is/services/NortekService";
    ...
    public is.idega.idegaweb.campus.webservice.nortek.client.NortekService getNortekService() throws javax.xml.rpc.ServiceException {
    ...
    public is.idega.idegaweb.campus.webservice.nortek.client.NortekService getNortekService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.campus.webservice.nortek.client.NortekServiceSoapBindingStub _stub = new is.idega.idegaweb.campus.webservice.nortek.client.NortekServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.campus.webservice.nortek.client.NortekService.class.isAssignableFrom(serviceEndpointInterface)) {
                is.idega.idegaweb.campus.webservice.nortek.client.NortekServiceSoapBindingStub _stub = new is.idega.idegaweb.campus.webservice.nortek.client.NortekServiceSoapBindingStub(new java.net.URL(NortekService_address), this);
                _stub.setPortName(getNortekServiceWSDDServiceName());
                return _stub;
            }
        }
