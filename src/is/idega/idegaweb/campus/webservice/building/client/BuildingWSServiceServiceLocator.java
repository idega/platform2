...
public class BuildingWSServiceServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.campus.webservice.building.client.BuildingWSServiceService {
    ...
    private java.lang.String BuildingService_address = "http://campusanza.sidan.is/services/BuildingService";
    ...
    public is.idega.idegaweb.campus.webservice.building.client.BuildingWSService getBuildingService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.campus.webservice.building.client.BuildingServiceSoapBindingStub _stub = new is.idega.idegaweb.campus.webservice.building.client.BuildingServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.campus.webservice.building.client.BuildingWSService.class.isAssignableFrom(serviceEndpointInterface)) {
                is.idega.idegaweb.campus.webservice.building.client.BuildingServiceSoapBindingStub _stub = new is.idega.idegaweb.campus.webservice.building.client.BuildingServiceSoapBindingStub(new java.net.URL(BuildingService_address), this);
                _stub.setPortName(getBuildingServiceWSDDServiceName());
                return _stub;
            }
        }
