...
public class CampusServiceServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.campus.webservice.general.client.CampusServiceService {
    ...
    private java.lang.String CampusService_address = "http://campusdemo.idega.is/services/CampusService";
    ...
    public is.idega.idegaweb.campus.webservice.general.client.CampusService getCampusService() throws javax.xml.rpc.ServiceException {
    ...
    public is.idega.idegaweb.campus.webservice.general.client.CampusService getCampusService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.campus.webservice.general.client.CampusServiceSoapBindingStub _stub = new is.idega.idegaweb.campus.webservice.general.client.CampusServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.campus.webservice.general.client.CampusService.class.isAssignableFrom(serviceEndpointInterface)) {
                is.idega.idegaweb.campus.webservice.general.client.CampusServiceSoapBindingStub _stub = new is.idega.idegaweb.campus.webservice.general.client.CampusServiceSoapBindingStub(new java.net.URL(CampusService_address), this);
                _stub.setPortName(getCampusServiceWSDDServiceName());
                return _stub;
            }
        }
