...
/**
 * Title Description: Shows number of habitants in the campus system Copyright:
 * Copyright (c) 2000-2001 idega.is All Rights Reserve Company: ideg
 * 
...
public class CampusHabitants extends CampusBlock {
	...
	public PresentationObject createResultTable(IWContext iwc)
			throws SQLException {
