...
import is.idega.idegaweb.member.isi.block.accounting.presentation.plugin.ClubCreditCardContractTab;
 ...
 * @author palli
 */
public class ClubCreditCardContractPluginBusinessBean extends IBOServiceBean implements ClubCreditCardContractPluginBusiness, UserGroupPlugInBusiness {
	...
	public List getGroupPropertiesTabs(Group group) throws RemoteException {
		...
		list.add(new ClubCreditCardContractTab(group));
