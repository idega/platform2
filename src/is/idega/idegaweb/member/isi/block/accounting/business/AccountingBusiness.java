...
public interface AccountingBusiness extends com.idega.business.IBOService
{
 ...
 public boolean doAssessment(java.lang.String p0,com.idega.user.data.Group p1,com.idega.user.data.Group p2,java.lang.String p3,com.idega.user.data.User p4,boolean p5,java.lang.String[] p6) throws java.rmi.RemoteException;
 ...
 public boolean insertTariff(com.idega.user.data.Group p0,java.lang.String p1,java.lang.String p2,java.lang.String p3,java.lang.String p4,java.sql.Date p5,java.sql.Date p6,boolean p7) throws java.rmi.RemoteException;
 public boolean insertTariff(com.idega.user.data.Group p0,com.idega.user.data.Group p1,is.idega.idegaweb.member.isi.block.accounting.data.ClubTariffType p2,java.lang.String p3,float p4,java.sql.Date p5,java.sql.Date p6,boolean p7) throws java.rmi.RemoteException;
