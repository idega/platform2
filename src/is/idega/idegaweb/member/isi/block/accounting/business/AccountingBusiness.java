...
public interface AccountingBusiness extends com.idega.business.IBOService
{
 ...
 public void equalizeBasket(java.util.Map p0,float p1,com.idega.idegaweb.IWUserContext p2) throws java.rmi.RemoteException;
 public void equalizeEntries(com.idega.user.data.Group p0,com.idega.user.data.Group p1,com.idega.user.data.User p2,float p3) throws java.rmi.RemoteException;
 ...
 public java.util.Collection getFinanceEntriesByDateIntervalDivisionsAndGroups(com.idega.user.data.Group p0,java.lang.String[] p1,java.sql.Date p2,java.sql.Date p3,java.util.Collection p4,java.util.Collection p5) throws java.rmi.RemoteException;
 public java.util.Collection getFinanceEntriesByEntryDateDivisionsAndGroups(com.idega.user.data.Group p0,java.lang.String p1,java.sql.Date p2,java.util.Collection p3,java.util.Collection p4) throws java.rmi.RemoteException;
 public java.util.Collection getFinanceEntriesByPaymentDateDivisionsAndGroups(com.idega.user.data.Group p0,java.lang.String[] p1,java.util.Collection p2,java.util.Collection p3) throws java.rmi.RemoteException;
