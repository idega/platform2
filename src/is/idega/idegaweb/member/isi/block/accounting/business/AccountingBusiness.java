...
public interface AccountingBusiness extends com.idega.business.IBOService
{
 ...
 public java.util.Collection getFinanceEntriesByDateIntervalDivisionsAndGroups(com.idega.user.data.Group p0,java.sql.Date p1,java.sql.Date p2,java.util.Collection p3,java.util.Collection p4) throws java.rmi.RemoteException;
