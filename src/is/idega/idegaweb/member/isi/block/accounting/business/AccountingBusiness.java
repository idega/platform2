...
public interface AccountingBusiness extends com.idega.business.IBOService
{
 ...
 public boolean insertPayment(is.idega.idegaweb.member.isi.block.accounting.data.PaymentType p0,int p1,com.idega.user.data.User p2,java.util.Map p3) throws java.rmi.RemoteException;
 public boolean insertPayment(java.lang.String p0,java.lang.String p1,com.idega.user.data.User p2,java.util.Map p3) throws java.rmi.RemoteException;
