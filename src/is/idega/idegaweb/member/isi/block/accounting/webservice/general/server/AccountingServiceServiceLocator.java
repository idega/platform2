...
public class AccountingServiceServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.member.isi.block.accounting.webservice.general.server.AccountingServiceService {
    ...
    public is.idega.idegaweb.member.isi.block.accounting.webservice.general.server.AccountingService getAccountingService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.member.isi.block.accounting.webservice.general.server.AccountingServiceSoapBindingStub _stub = new is.idega.idegaweb.member.isi.block.accounting.webservice.general.server.AccountingServiceSoapBindingStub(portAddress, this);
