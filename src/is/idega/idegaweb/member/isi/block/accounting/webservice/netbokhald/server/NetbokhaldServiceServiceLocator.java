...
public class NetbokhaldServiceServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.member.isi.block.accounting.webservice.netbokhald.server.NetbokhaldServiceService {
    ...
    public is.idega.idegaweb.member.isi.block.accounting.webservice.netbokhald.server.NetbokhaldService getNetbokhaldService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.member.isi.block.accounting.webservice.netbokhald.server.NetbokhaldServiceSoapBindingStub _stub = new is.idega.idegaweb.member.isi.block.accounting.webservice.netbokhald.server.NetbokhaldServiceSoapBindingStub(portAddress, this);
