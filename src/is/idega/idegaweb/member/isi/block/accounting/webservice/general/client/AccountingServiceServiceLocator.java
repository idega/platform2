    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.member.isi.block.accounting.webservice.general.client.AccountingService.class.isAssignableFrom(serviceEndpointInterface)) {
            	is.idega.idegaweb.member.isi.block.accounting.webservice.general.client.AccountingServiceSoapBindingStub _stub = new is.idega.idegaweb.member.isi.block.accounting.webservice.general.client.AccountingServiceSoapBindingStub(new java.net.URL(AccountingService_address), this);
                _stub.setPortName(getAccountingServiceWSDDServiceName());
                return _stub;
            }
        }
