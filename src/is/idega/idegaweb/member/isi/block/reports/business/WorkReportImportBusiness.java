...
public interface WorkReportImportBusiness extends com.idega.business.IBOService,is.idega.idegaweb.member.business.MemberUserBusiness
{
 ...
 public boolean importMemberPart(int p0,int p1,java.lang.String p2)throws is.idega.idegaweb.member.isi.block.reports.business.WorkReportImportException,java.rmi.RemoteException, java.rmi.RemoteException;
}
