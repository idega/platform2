 ...
 */
public class WorkReportWindowPlugin implements ToolbarElement {
	...
	public String getName(IWContext iwc) {
		...
		return resourceBundle.getLocalizedString("button.work_reports", "Work Reports");
	}
