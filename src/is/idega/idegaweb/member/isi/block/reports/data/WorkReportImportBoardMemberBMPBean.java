 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class WorkReportImportBoardMemberBMPBean extends GenericEntity implements WorkReportImportBoardMember {
	protected final static String ENTITY_NAME = "TMP_WR_BM";
	...
	public WorkReportImportBoardMemberBMPBean() {
		super();
	}
