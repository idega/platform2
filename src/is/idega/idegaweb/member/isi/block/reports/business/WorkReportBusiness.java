...
public interface WorkReportBusiness extends com.idega.business.IBOService,is.idega.idegaweb.member.business.MemberUserBusiness
{
 ...
 public boolean importAccountPart(int p0,int p1) throws java.rmi.RemoteException;
 public boolean importBoardPart(int p0,int p1) throws java.rmi.RemoteException;
 public boolean importMemberPart(int p0,int p1) throws java.rmi.RemoteException;
}
