...
import is.idega.idegaweb.member.presentation.GroupLogoTab;
 ...
 */
public class GroupLogoPluginBusinessBean extends IBOServiceBean implements GroupLogoPluginBusiness, UserGroupPlugInBusiness {
	...
	public List getGroupPropertiesTabs(Group group) throws RemoteException {
		...
		list.add(new GroupLogoTab(group));  
		return list;  
	}
