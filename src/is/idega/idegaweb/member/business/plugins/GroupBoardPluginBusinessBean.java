...
import is.idega.idegaweb.member.presentation.GroupBoardTab;
 ...
 */
public class GroupBoardPluginBusinessBean extends IBOServiceBean implements UserGroupPlugInBusiness, GroupBoardPluginBusiness {
	...
	public List getGroupPropertiesTabs(Group group) throws RemoteException {
		...
		list.add(new GroupBoardTab(group));
