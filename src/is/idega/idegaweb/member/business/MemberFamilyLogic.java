 ...
 * @author aron
 *
 * MemberFamilyLogic TODO Describe this type
 */
public interface MemberFamilyLogic {
     ...
     */
    public Collection getCustodiansFor(User user,
            boolean returnParentsIfNotFound) throws NoCustodianFound,
            RemoteException, java.rmi.RemoteException;
     ...
     */
    public void setAsChildFor(User personToSet, User parent)
