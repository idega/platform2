...
public interface MemberFamilyLogic extends com.idega.business.IBOService
{
 ...
 public void setAsChildFor(com.idega.user.data.User child,com.idega.user.data.User parent)throws java.rmi.RemoteException,javax.ejb.CreateException, java.rmi.RemoteException;
 ...
 public void setAsParentFor(com.idega.user.data.User parent,com.idega.user.data.User child)throws java.rmi.RemoteException,javax.ejb.CreateException, java.rmi.RemoteException;
 ...
 public void setAsSpouseFor(com.idega.user.data.User user,com.idega.user.data.User relateduser)throws java.rmi.RemoteException,javax.ejb.CreateException, java.rmi.RemoteException;
