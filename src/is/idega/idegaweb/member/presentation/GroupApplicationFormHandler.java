			...
			if( iwc.isParameterSet(USER_NAME_PARAM) && iwc.isParameterSet(PIN_PARAM) ){
				...
				if(adminComment==null){
					...
					if( credit && cardNumber!=null ){
						adminComment = "Vill borga me� kredit korti:\n"
						...
						adminComment = "Vill stadgrei�a\n";
					}
					else {
						adminComment = "Vill borga med korti en kortan�meri� vantar!\n";	
					}
					
					if( caretakerName!=null ){
						adminComment += "Forr��ama�ur : "+caretakerName+"\n"
