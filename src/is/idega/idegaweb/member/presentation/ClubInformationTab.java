...
public class ClubInformationTab extends UserGroupTab {
    ...
    public void initializeFieldValues() {
        ...
        fieldValues.put(_foundedFieldName, new IWTimestamp().getDate()
                .toString());
    ...
    public void updateFieldsDisplayStatus() {
        ...
        _memberUMFIField.setChecked(((Boolean) fieldValues
                .get(_memberUMFIFieldName)).booleanValue());
        ...
        String connection = (String) fieldValues
                .get(_connectionToSpecialFieldName);
            ...
            _makeField
                    .addMenuElement(
                            ...
                            iwrb.getLocalizedString(
                                    "clubinformationtab.single_division_club",
                                    "Single division"));
        } else {
            _makeField
                    .addMenuElement(
                            ...
                            iwrb.getLocalizedString(
                                    ...
                                    "Multi divisional"));//fj�lgreinaf�lag
            _makeField
                    .addMenuElement(
                            IWMemberConstants.META_DATA_CLUB_STATUS_SINGLE_DIVISION_CLUB,
                            iwrb.getLocalizedString(
                                    "clubinformationtab.single_division_club",
                                    "Single division"));//s�rgreinaf�lag
            _makeField.addMenuElement(
                    IWMemberConstants.META_DATA_CLUB_STATUS_NO_MEMBERS_CLUB,
                    iwrb.getLocalizedString(
                            "clubinformationtab.club_with_no_players",
                            "No players"));//f�lag �n i?kennda
            _makeField
                    .setToEnableWhenSelected(
                            _connectionToSpecialFieldName,
                            IWMemberConstants.META_DATA_CLUB_STATUS_SINGLE_DIVISION_CLUB);
        }
        _makeField.setSelectedElement(make);

        _regionalUnionField.setText((String) fieldValues
                .get(_regionalUnionFieldName));
        _statusField.setSelectedElement((String) fieldValues
                .get(_statusFieldName));
        _inOperationField.setChecked(((Boolean) fieldValues
                .get(_inOperationFieldName)).booleanValue());
        _usingMemberSystemField.setChecked(((Boolean) fieldValues
                .get(_usingMemberSystemFieldName)).booleanValue());
    }
    ...
    public void initializeFields() {
        ...
        _foundedField.setYearRange(1900, GregorianCalendar.getInstance().get(
        ...
        _connectionToSpecialField = new DropdownMenu(
                _connectionToSpecialFieldName);
        ...
        _statusField.addMenuElement(
                IWMemberConstants.META_DATA_CLUB_STATE_ACTIVE, iwrb
                        .getLocalizedString("clubinformationtab.state_active",
                                "Active"));
        _statusField.addMenuElement(
                IWMemberConstants.META_DATA_CLUB_STATE_INACTIVE,
                iwrb.getLocalizedString("clubinformationtab.state_inactive",
                        "Inactive"));
        _statusField.addMenuElement(
                IWMemberConstants.META_DATA_CLUB_STATE_COMPETITION_BAN, iwrb
                        .getLocalizedString(
        ...
        try {
            special = ((GroupHome) com.idega.data.IDOLookup
                    .getHome(Group.class))
                    .findGroupsByType(IWMemberConstants.GROUP_TYPE_LEAGUE);
        ...
        if (special != null) {
            ...
            while (it.hasNext()) {
                ...
                _connectionToSpecialField.addMenuElement(((Integer) spec
    ...
    public void initializeTexts() {
        ...
        _numberText = new Text(iwrb.getLocalizedString(_numberFieldName,
                "Number")
                + ":");
        ...
        _makeText = new Text(iwrb.getLocalizedString(_makeFieldName, "Make")
                + ":");
        _connectionToSpecialText = new Text(iwrb.getLocalizedString(
                _connectionToSpecialFieldName, "Connection to special")
                + ":");
        _regionalUnionText = new Text(iwrb.getLocalizedString(
                _regionalUnionFieldName, "Regional union")
                + ":");
        _statusText = new Text(iwrb.getLocalizedString(_statusFieldName,
                "Status")
                + ":");
        _inOperationText = new Text(iwrb.getLocalizedString(
                _inOperationFieldName, "In operation")
                + ":");
        _usingMemberSystemText = new Text(iwrb.getLocalizedString(
                _usingMemberSystemFieldName, "In member system")
                + ":");
    }
    ...
    public boolean collect(IWContext iwc) {
        if (iwc != null) {
            ...
            if (status != null)
                ...
                fieldValues.put(_statusFieldName, "");
            fieldValues.put(_inOperationFieldName, new Boolean(
                    inOperation != null));
            fieldValues.put(_usingMemberSystemFieldName, new Boolean(
                    using != null));
    ...
    public boolean store(IWContext iwc) {
        ...
        try {
            ...
            Boolean memberUMFI = (Boolean) fieldValues
                    .get(_memberUMFIFieldName);
            String make = (String) fieldValues.get(_makeFieldName);
            String connection = (String) fieldValues
                    .get(_connectionToSpecialFieldName);
            String status = (String) fieldValues.get(_statusFieldName);
            Boolean inOperation = (Boolean) fieldValues
                    .get(_inOperationFieldName);
            Boolean usingSystem = (Boolean) fieldValues
                    .get(_usingMemberSystemFieldName);
            ...
            if (make
                    .equals(IWMemberConstants.META_DATA_CLUB_STATUS_SINGLE_DIVISION_CLUB)) {
                String oldConnection = group
