...
public class ClubInformationTab extends UserGroupTab {
	...
	public void updateFieldsDisplayStatus() {
		...
		if (connection != null && !connection.equals("")) {
			...
			_makeField.addMenuElement(IWMemberConstants.META_DATA_CLUB_STATUS_MULTI_DIVISION_CLUB,iwrb.getLocalizedString("clubinformationtab.multi_division_club","Multi divisional"));//fj�lgreinaf�lag
			_makeField.addMenuElement(IWMemberConstants.META_DATA_CLUB_STATUS_SINGLE_DIVISION_CLUB,  iwrb.getLocalizedString("clubinformationtab.single_division_club","Single division"));//s�rgreinaf�lag
			_makeField.addMenuElement(IWMemberConstants.META_DATA_CLUB_STATUS_NO_MEMBERS_CLUB,  iwrb.getLocalizedString("clubinformationtab.club_with_no_players","No players"));//f�lag �n i?kennda
