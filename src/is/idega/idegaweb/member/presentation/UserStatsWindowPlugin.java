...
public class UserStatsWindowPlugin implements ToolbarElement {
	...
	public String getName(IWContext iwc) {
		...
		return resourceBundle.getLocalizedString("button.user_report_tool", "User Report Tool");
	}
