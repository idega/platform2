...
//			category.setToSubmit();
	...
	private PresentationObject getTypeDropdown(IWContext iwc, int selected) {
		...
		menu.addMenuElement(TYPE_SPECIAL, "Sérlisti");
		menu.addMenuElement(TYPE_MONTH, "Mánaðarfl.");
		menu.addMenuElement(TYPE_TOBACCO, "Tóbak");
	...
	private PresentationObject getCategoryDropdown(IWContext iwc, int selected) {
		...
		menu.addMenuElement(0, "(01) Rauðvín");
		menu.addMenuElement(1, "(02) Hvítvín");
