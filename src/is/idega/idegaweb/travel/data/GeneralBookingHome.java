...
public interface GeneralBookingHome extends com.idega.data.IDOHome
{
 ...
 public java.util.Collection findBookings(int[] p0,com.idega.util.idegaTimestamp p1,com.idega.util.idegaTimestamp p2,int[] p3,java.lang.String p4,java.lang.String p5,com.idega.block.trade.stockroom.data.TravelAddress p6)throws java.rmi.RemoteException,javax.ejb.FinderException, java.rmi.RemoteException;
 public java.util.Collection findBookings(int[] p0,int p1,com.idega.util.idegaTimestamp p2)throws javax.ejb.FinderException, java.rmi.RemoteException;
 ...
 public int getNumberOfBookings(int p0,com.idega.util.idegaTimestamp p1,com.idega.util.idegaTimestamp p2,int p3,int[] p4,java.util.Collection p5) throws java.rmi.RemoteException;
 public int getNumberOfBookings(int[] p0,int p1,com.idega.util.idegaTimestamp p2) throws java.rmi.RemoteException;
 public int getNumberOfBookings(int[] p0,int p1,com.idega.util.idegaTimestamp p2,java.util.Collection p3) throws java.rmi.RemoteException;
