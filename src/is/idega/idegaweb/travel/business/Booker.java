...
public interface Booker extends com.idega.business.IBOService
{
 ...
 public is.idega.idegaweb.travel.interfaces.Booking[] getBookings(int[] p0,com.idega.util.idegaTimestamp p1,com.idega.util.idegaTimestamp p2,int[] p3,com.idega.block.trade.stockroom.data.TravelAddress p4)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public is.idega.idegaweb.travel.interfaces.Booking[] getBookings(int p0,com.idega.util.idegaTimestamp p1,int[] p2)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public is.idega.idegaweb.travel.interfaces.Booking[] getBookings(int p0,com.idega.util.idegaTimestamp p1,com.idega.block.trade.stockroom.data.TravelAddress p2)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
