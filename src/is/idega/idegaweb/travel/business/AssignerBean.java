...
public class AssignerBean extends IBOServiceBean implements Assigner{
  ...
  public int getNumberOfAssignedSeats(Product product, idegaTimestamp stamp) throws RemoteException{
    int returner = 0;
  ...
  private int getNumberOfAssignedSeats(int serviceId,int resellerId, idegaTimestamp stamp, Connection conn) {
    int returner = 0;
    try {
        String[] many = {};
