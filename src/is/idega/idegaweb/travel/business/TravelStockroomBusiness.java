...
{
 public java.util.List getDepartureDays(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1,boolean p2)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public boolean getIfDay(com.idega.presentation.IWContext p0,is.idega.idegaweb.travel.data.Contract p1,com.idega.block.trade.stockroom.data.Product p2,com.idega.util.IWTimestamp p3)throws java.rmi.RemoteException,java.sql.SQLException,is.idega.idegaweb.travel.business.TimeframeNotFoundException,is.idega.idegaweb.travel.business.ServiceNotFoundException, java.rmi.RemoteException;
 ...
 public com.idega.block.trade.stockroom.data.Timeframe getTimeframe(com.idega.block.trade.stockroom.data.Product p0)throws is.idega.idegaweb.travel.business.TimeframeNotFoundException,is.idega.idegaweb.travel.business.ServiceNotFoundException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.List getDepartureDays(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public boolean getIfDay(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1,com.idega.block.trade.stockroom.data.Timeframe[] p2,com.idega.util.IWTimestamp p3)throws java.rmi.RemoteException,is.idega.idegaweb.travel.business.TimeframeNotFoundException,is.idega.idegaweb.travel.business.ServiceNotFoundException, java.rmi.RemoteException;
 public com.idega.block.trade.stockroom.data.Product[] getProducts(int p0,com.idega.util.IWTimestamp p1)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.trade.stockroom.data.Product[] getProducts(int p0,com.idega.util.IWTimestamp p1,com.idega.util.IWTimestamp p2)throws java.rmi.RemoteException,javax.ejb.FinderException, java.rmi.RemoteException;
 ...
 public int getTotalSeats(com.idega.block.trade.stockroom.data.Product p0,is.idega.idegaweb.travel.data.ServiceDay p1,com.idega.block.trade.stockroom.data.TravelAddress p2,com.idega.util.IWTimestamp p3)throws com.idega.data.IDOFinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public boolean isWithinTimeframe(com.idega.block.trade.stockroom.data.Timeframe p0,com.idega.util.IWTimestamp p1) throws java.rmi.RemoteException;
 ...
 public java.util.List getDepartureDays(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1,com.idega.util.IWTimestamp p2,com.idega.util.IWTimestamp p3)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.List getDepartureDays(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1,com.idega.util.IWTimestamp p2,com.idega.util.IWTimestamp p3,boolean p4)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public boolean getIfDay(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1,com.idega.block.trade.stockroom.data.Timeframe[] p2,com.idega.util.IWTimestamp p3,boolean p4,boolean p5)throws java.rmi.RemoteException,is.idega.idegaweb.travel.business.TimeframeNotFoundException,is.idega.idegaweb.travel.business.ServiceNotFoundException, java.rmi.RemoteException;
 ...
 public boolean getIfDay(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1,com.idega.util.IWTimestamp p2)throws java.rmi.RemoteException,java.sql.SQLException,is.idega.idegaweb.travel.business.TimeframeNotFoundException,is.idega.idegaweb.travel.business.ServiceNotFoundException, java.rmi.RemoteException;
