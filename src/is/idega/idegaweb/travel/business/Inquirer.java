...
public interface Inquirer extends com.idega.business.IBOService
{
 ...
 public is.idega.idegaweb.travel.data.Inquery[] getInqueries(int p0,com.idega.util.idegaTimestamp p1,boolean p2,java.lang.String p3)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public is.idega.idegaweb.travel.data.Inquery[] getInqueries(int p0,com.idega.util.idegaTimestamp p1,boolean p2)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public is.idega.idegaweb.travel.data.Inquery[] getInqueries(int p0,com.idega.util.idegaTimestamp p1,boolean p2,com.idega.block.trade.stockroom.data.TravelAddress p3,java.lang.String p4)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public is.idega.idegaweb.travel.data.Inquery[] getInqueries(int p0,com.idega.util.idegaTimestamp p1,boolean p2,com.idega.block.trade.stockroom.data.TravelAddress p3)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public int getInqueredSeats(int p0,com.idega.util.idegaTimestamp p1,boolean p2)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public int sendInquery(java.lang.String p0,java.lang.String p1,com.idega.util.idegaTimestamp p2,int p3,int p4,int p5,com.idega.block.trade.stockroom.data.Reseller p6)throws javax.ejb.CreateException,javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
}
