...
public interface ServiceHandler extends com.idega.business.IBOService
{
 ...
 public com.idega.util.idegaTimestamp getDepartureTime(int p0)throws java.sql.SQLException, java.rmi.RemoteException;
 public com.idega.util.idegaTimestamp getDepartureTime(com.idega.block.trade.stockroom.data.Product p0)throws java.sql.SQLException, java.rmi.RemoteException;
