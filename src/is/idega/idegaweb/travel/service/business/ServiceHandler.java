...
public interface ServiceHandler extends com.idega.business.IBOService
{
 ...
 public is.idega.idegaweb.travel.service.presentation.BookingOverview getBookingOverview(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.util.IWTimestamp getDepartureTime(com.idega.block.trade.stockroom.data.Product p0)throws java.rmi.RemoteException,java.sql.SQLException, java.rmi.RemoteException;
 ...
 public is.idega.idegaweb.travel.service.presentation.ServiceOverview getServiceOverview(com.idega.presentation.IWContext p0,com.idega.block.trade.stockroom.data.Product p1)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
