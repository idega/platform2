...
//            IWTimestamp currentStamp = new IWTimestamp(view_date);
    ...
    for (int g = 0; g < addressesSize; g++) {
      ...
      for (int i = 0; i < inqueries.length; i++) {
        ...
        link.addParameter(FishingBookingForm.parameterDepartureAddressId, trAddress.getID());
      ...
      daLink.addParameter(FishingBookingForm.parameterDepartureAddressId, trAddress.getID());
