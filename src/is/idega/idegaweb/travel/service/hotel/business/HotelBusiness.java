...
public interface HotelBusiness extends com.idega.business.IBOService, TravelStockroomBusiness
{
 public int createHotel(int p0,java.lang.Integer p1,java.lang.String p2,java.lang.String p3,java.lang.String p4,int p5,int p6,boolean p7,int p8,int[] p9, int[] hotelTypeIds, Float rating)throws java.lang.Exception, java.rmi.RemoteException;
 public void finalizeHotelCreation(com.idega.block.trade.stockroom.data.Product p0)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public int updateHotel(int p0,int p1,java.lang.Integer p2,java.lang.String p3,java.lang.String p4,java.lang.String p5,int p6,int p7,boolean p8,int p9,int[] p10, int[] hotelTypeIds, Float rating)throws java.lang.Exception, java.rmi.RemoteException;
}
