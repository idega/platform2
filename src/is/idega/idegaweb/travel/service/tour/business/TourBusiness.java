...
public interface TourBusiness extends TravelStockroomBusiness
{
 ...
 public java.util.List getDepartureDays(com.idega.presentation.IWContext p0,is.idega.idegaweb.travel.service.tour.data.Tour p1,com.idega.util.IWTimestamp p2,com.idega.util.IWTimestamp p3,boolean p4) throws java.rmi.RemoteException;
 ...
 public boolean getIfDay(com.idega.presentation.IWContext p0,is.idega.idegaweb.travel.data.Contract p1,is.idega.idegaweb.travel.service.tour.data.Tour p2,com.idega.util.IWTimestamp p3) throws java.rmi.RemoteException;
 public boolean getIfDay(com.idega.presentation.IWContext p0,is.idega.idegaweb.travel.service.tour.data.Tour p1,com.idega.util.IWTimestamp p2,boolean p3) throws java.rmi.RemoteException;
 ...
 public com.idega.util.IWTimestamp getNextAvailableDay(com.idega.presentation.IWContext p0,is.idega.idegaweb.travel.service.tour.data.Tour p1,com.idega.block.trade.stockroom.data.Product p2,com.idega.block.trade.stockroom.data.Timeframe p3,com.idega.util.IWTimestamp p4) throws java.rmi.RemoteException;
 public com.idega.util.IWTimestamp getNextAvailableDay(com.idega.presentation.IWContext p0,is.idega.idegaweb.travel.service.tour.data.Tour p1,com.idega.block.trade.stockroom.data.Product p2,com.idega.util.IWTimestamp p3)throws java.sql.SQLException, java.rmi.RemoteException;
