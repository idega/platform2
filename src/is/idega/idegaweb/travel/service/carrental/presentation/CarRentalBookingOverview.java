...
public class CarRentalBookingOverview extends AbstractBookingOverview {
...
//            IWTimestamp currentStamp = new IWTimestamp(view_date);
    ...
    for (int g = 0; g < addressesSize; g++) {
      ...
      for (int i = 0; i < inqueries.length; i++) {
        ...
        link.addParameter(CarRentalBookingForm.parameterDepartureAddressId, trAddress.getID());
      ...
      daLink.addParameter(CarRentalBookingForm.parameterDepartureAddressId, trAddress.getID());
