...
public class GolfTournamentAdminDialog extends PresentationObjectContainer {
	...
	public void main(IWContext modinfo) throws Exception {
		...
		if (AccessControl.isAdmin(modinfo) || AccessControl.isClubAdmin(modinfo)) {
			...
			Link lSelectTournament = new Link(iSelectTournament, TournamentSelectorWindow.class);
			...
			Link lPrintOuts = new Link(iPrintouts, PrintingWindow.class);
			//	    Link lPrintOuts = new Link(iPrintouts,"printing.jsp");
			lPrintOuts.addParameter(ADMIN_VIEW_PARAMETER, ADMIN_VIEW_PRINTING);

			Link lCreateTournament = new Link(iCreateTournament, TournamentCreatorWindow.class);
			...
			Link lFinish = new Link(iFinishTournament, CloseTournamentWindow.class);
			//	    Link lFinish = new
			// Link(iFinishTournament,"close_tournament.jsp");
			lFinish.addParameter(ADMIN_VIEW_PARAMETER, ADMIN_VIEW_FINISH_TOURNAMENT);
			Link lScore = new Link(iScorecard, ScorecardSelectWindow.class);
			...
			Link lSetupStartingtime = new Link(iSetupStartingtime, TournamentStartingtimeSetupWindow.class);
			lSetupStartingtime.addParameter(ADMIN_VIEW_PARAMETER, ADMIN_VIEW_SETUP_STARTINGTIME);
			Link lRegisterMember = new Link(iRegisterMember, TournamentRegistrationWindow.class);
			...
			Link lModifyTournament = new Link(iModifyTournament, TournamentUpdaterWindow.class);
			...
			Link lLists = new Link(iLists, TournamentListsWindow.class);
