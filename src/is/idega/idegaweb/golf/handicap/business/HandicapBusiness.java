...
public interface HandicapBusiness extends com.idega.business.IBOService
{
 ...
 public java.util.Collection getScorecards() throws javax.ejb.FinderException, java.rmi.RemoteException;
 ...
 public int getStrokesCountByScorecard(Object scorecardID) throws java.rmi.RemoteException;
}
