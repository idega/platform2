...
public TextEditor(boolean isAdmin){
	...
	public void main(IWContext modinfo) throws Exception {
                ...
                isAdmin=is.idega.idegaweb.golf.block.login.business.AccessControl.isAdmin(modinfo);
	...
	public void newText(IWContext modinfo) throws IOException,SQLException {
	...
	public void saveText(IWContext modinfo) throws IOException,SQLException {
	...
	public void deleteText(IWContext modinfo) throws IOException,SQLException {
	...
	public void confirmDelete(IWContext modinfo) throws IOException,SQLException {
