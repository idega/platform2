...
public class TextModuleBMPBean extends GenericEntity implements TextModule {

	public TextModuleBMPBean(){
		super();
	}

	public TextModuleBMPBean(int id)throws SQLException{
		super(id);
	}
	...
	/*public String getIDColumnName(){
        ...
        public void setDefaultValues() {
          com.idega.util.IWTimestamp stamp = new com.idega.util.IWTimestamp();
