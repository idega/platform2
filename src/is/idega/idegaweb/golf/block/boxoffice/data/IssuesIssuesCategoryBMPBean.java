...
public class IssuesIssuesCategoryBMPBean extends GenericEntity{

	public IssuesIssuesCategoryBMPBean() {
		super();
	}

	public IssuesIssuesCategoryBMPBean(int id) throws SQLException {
		super(id);
	}
	...
	public String getIDColumnName(){
		return "issues_issues_category_id";
	}

	public String getEntityName(){
		return "issues_issues_category";
	}
	...
	public String getIssueCategoryName()throws SQLException{
		...
		try{
			IssuesCategory issues = ((IssuesCategoryHome)IDOLookup.getHomeLegacy(IssuesCategory.class)).findByPrimaryKeyLegacy(this.getIssueCategoryId());
	...
	public int getIssueCategoryImage()throws SQLException{
		int image_id = 0;
		try{
			IssuesCategory issue_category = ((IssuesCategoryHome)IDOLookup.getHomeLegacy(IssuesCategory.class)).findByPrimaryKeyLegacy(this.getIssueCategoryId());
