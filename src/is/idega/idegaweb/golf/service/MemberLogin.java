...
public class MemberLogin extends Editor{
  ...
  protected void control(IWContext iwc){
    ...
    if(member_id != null && union_id != null){
      ...
      try{
        ...
        eMember = ((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(Integer.parseInt(member_id));
  ...
  public boolean registerMemberLogin(int member_id,String user_login,String user_pass_one,String user_pass_two) throws SQLException {
    ...
    if (user_pass_one.equals(user_pass_two)) {
      ...
      LoginTable[] logTable = (LoginTable[]) (((is.idega.idegaweb.golf.entity.LoginTableHome)com.idega.data.IDOLookup.getHomeLegacy(LoginTable.class)).createLegacy()).findAllByColumn("USER_LOGIN",user_login);

      if (logTable.length == 0) {

          LoginTable logT = ((is.idega.idegaweb.golf.entity.LoginTableHome)com.idega.data.IDOLookup.getHomeLegacy(LoginTable.class)).createLegacy();
  ...
  public  String getUserLogin(int iMemberId)throws SQLException{
    ...
    LoginTable[] logins = (LoginTable[])((is.idega.idegaweb.golf.entity.LoginTableHome)com.idega.data.IDOLookup.getHomeLegacy(LoginTable.class)).createLegacy().findAllByColumn("MEMBER_ID",iMemberId);
