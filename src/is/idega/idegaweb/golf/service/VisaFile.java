...
public class VisaFile  {
  ...
  public void writeFile(IWContext modinfo,Payment[] ePayments, String sContract, double dPercent, int iAmount, int iUnionId)throws SQLException,IOException,FinderException{
    ...
    PaymentType PayType = ((PaymentTypeHome) IDOLookup.getHomeLegacy(Payment.class)).findByPrimaryKey(2);
  ...
  private void visaFiling(IWContext modinfo,int roundid,String contract,double prosent, int amount) throws SQLException,IOException,FinderException{
