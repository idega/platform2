 ...
 public class GolfMemberInsert extends Editor{
      ...
      if(iUnionId != -1){
        ...
        if(iMemberId != -1)
          ...
          try{
            ...
            eMember = ((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(iMemberId);
            ...
            eCard = ((is.idega.idegaweb.golf.entity.CardHome)com.idega.data.IDOLookup.getHomeLegacy(Card.class)).findByPrimaryKeyLegacy(eUMI.getCardId());
  ...
  private void insert(IWContext iwc)throws SQLException, IOException {
    ...
    if(eMember == null) {
        ...
        Family family = ((is.idega.idegaweb.golf.entity.FamilyHome)com.idega.data.IDOLookup.getHomeLegacy(Family.class)).createLegacy();
  ...
  public BorderTable getGroupTable() {
    ...
    if(eMember!=null){//debug eiki
        ...
        Union uni = ((is.idega.idegaweb.golf.entity.UnionHome)com.idega.data.IDOLookup.getHomeLegacy(Union.class)).findByPrimaryKeyLegacy(iUnionId);
        ...
        Group theGroup = ((is.idega.idegaweb.golf.entity.GroupHome)com.idega.data.IDOLookup.getHomeLegacy(Group.class)).createLegacy();
    ...
    if(eMember != null) {
      ...
      //debug eiki added union_id
          ...
          for( int k=0; k<uniarr.length ; k++){
            ...
            vector.addElement(((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(  uniarr[k].getMemberID() ));
