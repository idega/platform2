...
public class GroupInsert extends EntityInsert {
  ...
  public void store(IWContext iwc,Member mem)throws SQLException, IOException {
    ...
    for(int i = 0; i < selectGroupsValues.length; i++) {
        ...
        eMember.addTo(((is.idega.idegaweb.golf.entity.GroupHome)com.idega.data.IDOLookup.getHomeLegacy(Group.class)).findByPrimaryKeyLegacy(Integer.parseInt(selectGroupsValues[i])));
