...
public class PhoneInsert extends EntityInsert {
  ...
  public PhoneInsert() {
    ...
    ePhone = ((is.idega.idegaweb.golf.entity.PhoneHome)com.idega.data.IDOLookup.getHomeLegacy(Phone.class)).createLegacy();
  ...
  public PhoneInsert( String inputPhoneName, String countryDropName, String dropdownTypeName) {
    ...
    this.ePhone = ((is.idega.idegaweb.golf.entity.PhoneHome)com.idega.data.IDOLookup.getHomeLegacy(Phone.class)).createLegacy();
  ...
  private DropdownMenu typeDropDown(String name, String selected) {
    ...
    PhoneType type = ((is.idega.idegaweb.golf.entity.PhoneTypeHome)com.idega.data.IDOLookup.getHomeLegacy(PhoneType.class)).createLegacy();
