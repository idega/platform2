 ...
 public class PaymentViewer extends com.idega.presentation.PresentationObjectContainer {
  ...
  private void control(IWContext iwc) throws IOException{
    ...
    try{
      ...
      union = ((is.idega.idegaweb.golf.entity.UnionHome)com.idega.data.IDOLookup.getHomeLegacy(Union.class)).findByPrimaryKeyLegacy(un_id);
      ...
      if( member_id != null){
        ...
        thisMember = ((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(mem_id);
    ...
    private void doChange(IWContext iwc) throws SQLException{
      ...
      PaymentType[] PT = (PaymentType[])(((is.idega.idegaweb.golf.entity.PaymentTypeHome)com.idega.data.IDOLookup.getHomeLegacy(PaymentType.class)).createLegacy()).findAll();
    ...
    private void doNew(IWContext iwc) throws SQLException{
      ...
      PaymentRound[] PR = (PaymentRound[]) (((is.idega.idegaweb.golf.entity.PaymentRoundHome)com.idega.data.IDOLookup.getHomeLegacy(PaymentRound.class)).createLegacy()).findAllByColumnDescendingOrdered("union_id",union_id,"round_date");
    ...
    private Table makeTopTable(){
      ...
      if(memberPayments != null){
        ...
        for(int i = 0 ; i < len; i ++){
          ...
          pt = ((is.idega.idegaweb.golf.entity.PaymentTypeHome)com.idega.data.IDOLookup.getHomeLegacy(PaymentType.class)).findByPrimaryKeyLegacy(memberPayments[i].getPaymentTypeID());
    ...
    private void createAccount(int member_id, int union_id, int cashier_id)throws SQLException{
      ...
      Account account = ((is.idega.idegaweb.golf.entity.AccountHome)com.idega.data.IDOLookup.getHomeLegacy(Account.class)).createLegacy();
    ...
    private Payment[] getPayments(int member_id){
      ...
      try{
        ...
        //P = (Payment[]) (((is.idega.idegaweb.golf.entity.PaymentHome)com.idega.data.IDOLookup.getHomeLegacy(Payment.class)).createLegacy()).findAll("select * from payment where member_id = '"+member_id+"' and (payment_date <= '"+today.getYear()+"-01-01'  or  status ='Y' ") ;

        //P = (Payment[]) (((is.idega.idegaweb.golf.entity.PaymentHome)com.idega.data.IDOLookup.getHomeLegacy(Payment.class)).createLegacy()).findAllByColumn("member_id",String.valueOf(member_id));

        P = (Payment[]) (((is.idega.idegaweb.golf.entity.PaymentHome)com.idega.data.IDOLookup.getHomeLegacy(Payment.class)).createLegacy()).findAll("select * from payment where member_id = '"+member_id+"' and round_id in ( select payment_round_id from payment_round where union_id like '"+union_id+"' ) ") ;
    ...
    public static Table getMemberPayments(String member_id,String union_id )throws SQLException{
      ...
      Payment[] payments = (Payment[]) (((is.idega.idegaweb.golf.entity.PaymentHome)com.idega.data.IDOLookup.getHomeLegacy(Payment.class)).createLegacy()).findAllByColumnOrdered("member_id",member_id,"payment_date");
