...
public class GroupMemberInsertWindow extends com.idega.presentation.ui.Window{
  ...
  public void store(IWContext iwc)throws SQLException, IOException {
      ...
      selectGroupsValues = iwc.getRequest().getParameterValues(((is.idega.idegaweb.golf.entity.GroupHome)com.idega.data.IDOLookup.getHomeLegacy(Group.class)).createLegacy().getEntityName());
      ...
      for(int i = 0; i < selectGroupsValues.length; i++) {
          ...
          member.addTo(((is.idega.idegaweb.golf.entity.GroupHome)com.idega.data.IDOLookup.getHomeLegacy(Group.class)).findByPrimaryKeyLegacy(Integer.parseInt(selectGroupsValues[i])));
