...
//  private Connection conn;
  ...
  startTime = ((is.idega.idegaweb.golf.entity.StartingtimeHome)com.idega.data.IDOLookup.getHomeLegacy(Startingtime.class)).createLegacy();
...
public Startingtime[] findAllPlayersInFieldOrdered(String field_id, String orderby_clause)throws IOException, SQLException{
	...
	Startingtime stime = ((is.idega.idegaweb.golf.entity.StartingtimeHome)com.idega.data.IDOLookup.getHomeLegacy(Startingtime.class)).createLegacy();
