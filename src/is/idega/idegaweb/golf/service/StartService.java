...
public class StartService {
	...
	private Startingtime startTime; //notaður sem almennur hlutur til að nalgast
																	// almenn föll ohað id
	...
	public StartService() { //throws SQLException{
		super();
		startTime = (Startingtime) IDOLookup.instanciateEntity(Startingtime.class);
	...
	public synchronized Startingtime[] getTableEntries(String date, int first_group, int last_group, int field_id) throws SQLException {
		...
		//    return (Startingtime[])startTime.findAll("SELECT * FROM " +
	...
	public synchronized void preSetStartingtime(int group_num, String date, String field_id) throws SQLException {
		Startingtime insert = (Startingtime) IDOLookup.createLegacy(Startingtime.class);
	...
	public synchronized String getFieldName(int field_id) throws FinderException {
	...
	public synchronized int get_field_union(int field_id) throws FinderException {
