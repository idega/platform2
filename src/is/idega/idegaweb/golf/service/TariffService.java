...
public class TariffService  {
  ...
  static public Account[] getAccounts(int iMemberId, int iUnionId){
    ...
    try{
      ...
      Account[] A = (Account[])((is.idega.idegaweb.golf.entity.AccountHome)com.idega.data.IDOLookup.getHomeLegacy(Account.class)).createLegacy().findAllByColumn("member_id",String.valueOf(iMemberId),"union_id",String.valueOf(iUnionId));
  ...
  static public int findAccountID(int member_id, int union_id){
    ...
    try{
      ...
      Account[] A = (Account[]) (((is.idega.idegaweb.golf.entity.AccountHome)com.idega.data.IDOLookup.getHomeLegacy(Account.class)).createLegacy()).findAllByColumn("member_id",String.valueOf(member_id),"union_id",String.valueOf(union_id));
  ...
  static public Account findAccount(int member_id, int union_id,int accountYearId){
    ...
    try{
      ...
      Account[] A = (Account[]) (((is.idega.idegaweb.golf.entity.AccountHome)com.idega.data.IDOLookup.getHomeLegacy(Account.class)).createLegacy()).findAllByColumn(
  ...
  static public Payment[] getMemberPayments(int iMemberId,int iUnionId){
    ...
    try{
      ...
      P = (Payment[]) ((is.idega.idegaweb.golf.entity.PaymentHome)com.idega.data.IDOLookup.getHomeLegacy(Payment.class)).createLegacy().findAllByColumnOrdered("member_id",String.valueOf(iMemberId),"union_id",String.valueOf(iUnionId),"last_updated");
   ...
   static public Payment[] getMemberPayments(int iAccountId,int iUnionId,idegaTimestamp from,idegaTimestamp to){

     Payment[] P;

    Payment entry = ((is.idega.idegaweb.golf.entity.PaymentHome)com.idega.data.IDOLookup.getHomeLegacy(Payment.class)).createLegacy();
    ...
    try{
      ...
      P = (Payment[]) ((is.idega.idegaweb.golf.entity.PaymentHome)com.idega.data.IDOLookup.getHomeLegacy(Payment.class)).createLegacy().findAll(sql.toString());
  ...
  static public AccountEntry[] getAccountEntrys(int iAccountId){
    ...
    try{
      ...
      E = (AccountEntry[]) ((is.idega.idegaweb.golf.entity.AccountEntryHome)com.idega.data.IDOLookup.getHomeLegacy(AccountEntry.class)).createLegacy().findAllByColumnOrdered("account_id",String.valueOf(iAccountId),"last_updated");
  ...
  static public AccountEntry[] getAccountEntrys(int iAccountId,idegaTimestamp from,idegaTimestamp to){

    AccountEntry[] E;

    AccountEntry entry = ((is.idega.idegaweb.golf.entity.AccountEntryHome)com.idega.data.IDOLookup.getHomeLegacy(AccountEntry.class)).createLegacy();
    ...
    try{
      ...
      E = (AccountEntry[]) ((is.idega.idegaweb.golf.entity.AccountEntryHome)com.idega.data.IDOLookup.getHomeLegacy(AccountEntry.class)).createLegacy().findAll(sql.toString());
  ...
  static public AccountEntry[] getTariffEntrys(int iAccountId){
    ...
    try{
      ...
      E = (AccountEntry[]) ((is.idega.idegaweb.golf.entity.AccountEntryHome)com.idega.data.IDOLookup.getHomeLegacy(AccountEntry.class)).createLegacy().findAllByColumnOrdered("account_id",String.valueOf(iAccountId),"info","Álagning","last_updated");
  ...
  static public AccountEntry[] getTariffEntrys(int iAccountId,idegaTimestamp from,idegaTimestamp to){
  ...
  static public Account makeNewAccount(int MemberId,int UnionId,String Name,int CashierId,int accountYearId){
   ...
   static public AccountEntry makeAnAccountEntry(int AccountId,int Price, String Name,String Info,String AccountKey,String EntryKey,String TariffKey,int CashierId,Timestamp PaymentDate,Timestamp LastUpdated) throws SQLException{
  ...
  static public void makeAccountEntry(int AccountId,int Price, String Name,String Info,String AccountKey,String EntryKey,String TariffKey,int CashierId,Timestamp PaymentDate,Timestamp LastUpdated) throws SQLException{
  ...
  static public List getMemberFamily(int iMemberId,int iUnionId){
    ...
    try{
      ...
      UnionMemberInfo umi = ((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(iMemberId).getUnionMemberInfo(iUnionId);

      List M = EntityFinder.findAll(((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).createLegacy(),getFamilySql(iUnionId,umi.getFamilyId()));
