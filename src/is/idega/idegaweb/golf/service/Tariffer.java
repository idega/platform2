...
public class Tariffer extends PresentationObjectContainer {
      ...
      if(isAdmin){
        ...
        if(iwc.isParameterSet("accyid")){
          ...
          try {
            ...
            AccountYear ay = new AccountYear(id);
  ...
  private String getDateString(idegaTimestamp stamp){
   ...
   private idegaTimestamp parseStamp(String sDate){
    ...
    private List listOfYears(String union_id) throws SQLException{
      List L = EntityFinder.findAllByColumn(new AccountYear(),"union_id",union_id);
      return L;
    }
  ...
  private Hashtable getAccountsHash(int mainYear){
    ...
    try{
      ...
      Account[] A = (Account[])new Account().findAll(sql.toString());
