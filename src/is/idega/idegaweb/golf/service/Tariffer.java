...
public class Tariffer extends PresentationObjectContainer {
  ...
  public Tariffer(){
    ...
    pricecatalogue = ((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy();
  ...
  private void control(IWContext iwc) throws IOException{
    ...
    try{
      ...
      unions = (Union[]) (((is.idega.idegaweb.golf.entity.UnionHome)com.idega.data.IDOLookup.getHomeLegacy(Union.class)).createLegacy()).findAllByColumn("union_id",un_id);
      ...
      if(iwc.getParameter("catal_action") == null){
      ...
      if(iwc.getParameter("catal_action") != null){
        ...
        catal_action = iwc.getParameter("catal_action");



        if(catal_action.equals("main")){ doMain(iwc); }

        else if(catal_action.equals("change")){ doChange(iwc); }

        else if(catal_action.equals("update")){ doUpdate(iwc); }

        else if(catal_action.equals("view")){ doView(iwc); }

        else if(catal_action.equals("save")){ doSave(iwc); }

        else if(catal_action.equals("list")){ doList(iwc); }

        else if(catal_action.equals("file")){ doFile(iwc); }

        else if(catal_action.equals("price")){ doNotPrice(iwc); }

        else if(catal_action.equals("skrifa")){ doSkrifa(iwc); }

        else if(catal_action.equals("gjalda")){ doPrice(iwc); }

        else if(catal_action.equals("updateextra")){ doUpdateExtra(iwc); }

        else if(catal_action.equals("seek")){ doSeek(iwc); }

        else if(catal_action.equals("year")){ doYear(iwc); }
    ...
    private void doMain(IWContext iwc) throws SQLException {
      ...
      PriceCatalogue pricecatalog = ((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy();
     ...
     private void doYear(IWContext iwc) throws SQLException {

      if(iwc.isParameterSet("saveyear"))

        processYear(iwc);

      AccountYear year = ((is.idega.idegaweb.golf.entity.AccountYearHome)com.idega.data.IDOLookup.getHomeLegacy(AccountYear.class)).createLegacy();
      ...
      if(isAdmin){
        ...
        if(iwc.isParameterSet("accyid")){

          int id = Integer.parseInt(iwc.getParameter("accyid"));

          try {



            AccountYear ay = ((is.idega.idegaweb.golf.entity.AccountYearHome)com.idega.data.IDOLookup.getHomeLegacy(AccountYear.class)).findByPrimaryKeyLegacy(id);
  ...
  private void processYear(IWContext iwc){

    String name = iwc.getParameter("year_name");
    ...
    boolean active = iwc.isParameterSet("activecheck");

    int id = -1;

    if(iwc.isParameterSet("year_id"))

      id = Integer.parseInt(iwc.getParameter("year_id"));
    ...
    try {
      ...
      if(id > 0)
        ...
        year = ((is.idega.idegaweb.golf.entity.AccountYearHome)com.idega.data.IDOLookup.getHomeLegacy(AccountYear.class)).findByPrimaryKeyLegacy(id);
  ...
  private String getDateString(IWTimestamp stamp){
   ...
   private IWTimestamp parseStamp(String sDate){
    ...
    private void doUpdate(IWContext iwc) throws SQLException{
      ...
      int number = Integer.parseInt(iwc.getParameter("numofcatal"));
      ...
      for (int i = 1; i < number+1 ;i++){
        ...
        text = iwc.getParameter("catal_text"+i );

        price = iwc.getParameter("catal_price"+i);

        agefrom = iwc.getParameter("catal_agefrom"+i);

        ageto = iwc.getParameter("catal_ageto"+i);

        gender = iwc.getParameter("catal_gender"+i);

        extra = iwc.getParameter("catal_extra"+i);
    ...
    private void doList(IWContext iwc) throws SQLException{
      ...
      int number = Integer.parseInt(iwc.getParameter("catal_list_number"));

      String listextra = iwc.getParameter("listextra");
      ...
      for(int b = 0; b < len ; b++){
        ...
        if(ExtraCatalogs){
          ...
          if(PcCheck ){
            ...
            PriceCatalogue p = ((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).findByPrimaryKeyLegacy(pcnr);
    ...
    private void doUpdateExtra(IWContext iwc) throws SQLException{
      ...
      int number = Integer.parseInt(iwc.getParameter("numofextra"));
      ...
      for (int i = 0; i < number ;i++){
        ...
        strExtraCatalNumber = iwc.getParameter("catal_extrapcdrop"+i);

        extraCatalNumber = Integer.parseInt(strExtraCatalNumber);

        membernumber = iwc.getParameter("membernumber"+i);

        if(extraCatalNumber != 0){

          M = ((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(Integer.parseInt(membernumber));
    ...
    private void doFile(IWContext iwc) throws SQLException{
      ...
      PaymentRound[] rounds = (PaymentRound[]) (((is.idega.idegaweb.golf.entity.PaymentRoundHome)com.idega.data.IDOLookup.getHomeLegacy(PaymentRound.class)).createLegacy()).findAllByColumnDescendingOrdered("union_id", union_id,"round_date");
    ...
    private void doSkrifa(IWContext iwc) throws SQLException,IOException{
      ...
      String bank = iwc.getParameter("catal_bank");

      String bnkofc = iwc.getParameter("catal_bank_office");

      String kreditcc = iwc.getParameter("catal_kreditcc");

      String roundstring = iwc.getParameter("catal_round");
      ...
      try{
        ...
        if(!roundstring.equalsIgnoreCase("noround")){
          ...
          if(!bank.equalsIgnoreCase("nobnk")){
            ...
            int finalpayday = Integer.parseInt(iwc.getParameter("catal_finalpayday"));

            String B1input = iwc.getParameter("catal_girotext1");

            String B2input = iwc.getParameter("catal_girotext2");

            String B3input = iwc.getParameter("catal_girotext3");

            String B4input = iwc.getParameter("catal_girotext4");
          ...
          if(!kreditcc.equalsIgnoreCase("nocr")){
            ...
            String kreditPr = iwc.getParameter("catal_kredit_pr");

            String kreditKr = iwc.getParameter("catal_kredit_kr");

            String contractnr = iwc.getParameter("catal_kredit_contract");
    ...
    private void doNotPrice(IWContext iwc)throws SQLException{
      ...
      for(int i = year-3 ; i < year+3; i++){  drdGiroPaymentYear.addMenuElement( String.valueOf(i));}
      ...
      for(int i = year-3 ; i < year+3; i++){  drdEuroPaymentYear.addMenuElement( String.valueOf(i));}
      ...
      for(int i = year-3 ; i < year+3; i++){  drdVisaPaymentYear.addMenuElement( String.valueOf(i));}
      ...
      Table DefineTable = new Table(4,10);
      ...
      DefineTable.add(sYearOfPay,1,10);
      ...
      DefineTable.add(drdGiroPaymentYear,2,10);
      ...
      DefineTable.add(drdEuroPaymentYear,3,10);
      ...
      DefineTable.add(drdVisaPaymentYear,4,10);
    ...
    private void doPrice(IWContext iwc) throws SQLException{
      ...
      String ifEuro = iwc.getParameter("catal_euro_choice");

      String ifVisa = iwc.getParameter("catal_visa_choice");
      ...
      System.err.print("\nÁlagning hefst "+ new IWTimestamp().toSQLTimeString());
        ...
        if(ifGiro != null &&ifGiro.equalsIgnoreCase("true")){
          ...
          defGiroInstlm =  Integer.parseInt( iwc.getParameter("catal_giro_installments"));

          defGiroPayday =  Integer.parseInt( iwc.getParameter("catal_giro_payday"));

          defGiroFirstMonth =  Integer.parseInt( iwc.getParameter("catal_giro_firstmonth"));

          defGiroYear =  Integer.parseInt( iwc.getParameter("catal_giro_payyear"));

          String sGiroInterest =  iwc.getParameter("catal_giro_bankinterest");

          String sGiroCost =  iwc.getParameter("catal_giro_bankcost");
          ...
          letThemPay(iwc , 1 , defGiroInstlm , defGiroYear,defGiroFirstMonth , defGiroPayday ,dGiroInterest,iGiroCost);
        ...
        if(ifEuro != null && ifEuro.equalsIgnoreCase("true")){
          ...
          defEuroInstlm =  Integer.parseInt( iwc.getParameter("catal_euro_installments"));

          defEuroPayday =  Integer.parseInt( iwc.getParameter("catal_euro_payday"));

          defEuroFirstMonth =  Integer.parseInt( iwc.getParameter("catal_euro_firstmonth"));

          defEuroYear =  Integer.parseInt( iwc.getParameter("catal_euro_payyear"));

          String sEuroInterest =  iwc.getParameter("catal_euro_bankinterest");

          String sEuroCost =  iwc.getParameter("catal_euro_bankcost");
          ...
          letThemPay(iwc , 2 , defEuroInstlm ,defEuroYear, defEuroFirstMonth , defEuroPayday , dEuroInterest,iEuroCost);
        ...
        if(ifVisa != null && ifVisa.equalsIgnoreCase("true")){
          ...
          defVisaInstlm =  Integer.parseInt( iwc.getParameter("catal_visa_installments"));

          defVisaPayday =  Integer.parseInt( iwc.getParameter("catal_visa_payday"));

          defVisaFirstMonth =  Integer.parseInt( iwc.getParameter("catal_visa_firstmonth"));

          defVisaYear =  Integer.parseInt( iwc.getParameter("catal_visa_payyear"));

          String sVisaInterest =  iwc.getParameter("catal_visa_bankinterest");

          String sVisaCost =  iwc.getParameter("catal_visa_bankcost");
          ...
          letThemPay(iwc , 3 , defVisaInstlm ,defVisaYear, defVisaFirstMonth , defVisaPayday,dVisaInterest, iVisaCost );
    ...
    private List getCatalogList(String union_id) throws SQLException{
      ...
      List L = EntityFinder.findAllByColumn(((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy(),"union_id",union_id,"in_use","Y","is_independent","N");
    ...
    private List listOfYears(String union_id) throws SQLException{
      ...
      List L = EntityFinder.findAllByColumn(((is.idega.idegaweb.golf.entity.AccountYearHome)com.idega.data.IDOLookup.getHomeLegacy(AccountYear.class)).createLegacy(),"union_id",union_id);
    ...
    public static List getExtraCatalogList(String union_id) throws SQLException{
      ...
      return EntityFinder.findAllByColumn(((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy(),"union_id",union_id,"in_use","Y","is_independent","Y");
    ...
    public PriceCatalogue[] getExtraCatalogues(String unionID) throws SQLException{
      ...
      PriceCatalogue[] PCs = (PriceCatalogue[])(((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy()).findAll( getExtraCatalogueSQL(unionID));
  ...
  private void saveCatalogs()throws SQLException{
    ...
    for(int i = 0; i < Values.length; i++){
      ...
      if(!(text.equalsIgnoreCase("null")) && !(price.equalsIgnoreCase("null"))){
        ...
        pcl = ((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy();
  ...
  private Hashtable getAccountsHash(int mainYear){
    ...
    try{
      ...
      //Account[] A = (Account[])((is.idega.idegaweb.golf.entity.AccountHome)com.idega.data.IDOLookup.getHomeLegacy(Account.class)).createLegacy().findAllByColumn("union_id",this.union_id);

      Account[] A = (Account[])((is.idega.idegaweb.golf.entity.AccountHome)com.idega.data.IDOLookup.getHomeLegacy(Account.class)).createLegacy().findAll(sql.toString());
  ...
  private void seekThem(IWContext iwc) throws SQLException{
    ...
    for(int a = 0; a < memberCount; a++){
      ...
      member = ((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(mbid);
    ...
    if(IndependentMembersInfoList!=null){
      ...
      for(int i = 0; i < IndependentMembersInfoList.size();i++){
        ...
        mbsVectorArray[mbsVectorArray.length-2].addElement(((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(UMI.getMemberID()));
  ...
  private void letThemPay(IWContext iwc, int payTypeId, int defaultInstallmentNr,int defaultYear, int defaultFirstMonth, int defaultPayday,double fBankInterest,int iBankCost) throws SQLException{
    ...
    PaymentRound round = ((is.idega.idegaweb.golf.entity.PaymentRoundHome)com.idega.data.IDOLookup.getHomeLegacy(PaymentRound.class)).createLegacy();
    ...
    PriceCatalogue PC = ((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy();
      ...
      if(pmID == payTypeId){
        ...
        for(int j = 0; j < mbgr.length; j++){
          ...
          // inDependent catalogues
            ...
            PriceCatalogue Pr = ((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).findByPrimaryKeyLegacy(UMI.getPriceCatalogueID());
  ...
  private int makeNewAccount(int MemberId,int UnionId,String Name,int CashierId,int accountYear){
    ...
    Account A = ((is.idega.idegaweb.golf.entity.AccountHome)com.idega.data.IDOLookup.getHomeLegacy(Account.class)).createLegacy();
  ...
  private void makeAccountEntry(int AccountId,int Price, String Name,String Info,String AccountKey,String EntryKey,String TariffKey,int CashierId,Timestamp PaymentDate,Timestamp LastUpdated) throws SQLException{
    ...
    AccountEntry E = ((is.idega.idegaweb.golf.entity.AccountEntryHome)com.idega.data.IDOLookup.getHomeLegacy(AccountEntry.class)).createLegacy();
    ...
    Account A = ((is.idega.idegaweb.golf.entity.AccountHome)com.idega.data.IDOLookup.getHomeLegacy(Account.class)).findByPrimaryKeyLegacy(AccountId);
