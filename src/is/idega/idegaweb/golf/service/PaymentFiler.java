...
public class PaymentFiler  {
  ...
  public void makeFile(IWContext iwc,String filepath,int payment_type_id,int account_year_id,int union_id) throws SQLException,IOException{
    ...
    PaymentType payType = ((is.idega.idegaweb.golf.entity.PaymentTypeHome)com.idega.data.IDOLookup.getHomeLegacy(PaymentType.class)).findByPrimaryKeyLegacy(payment_type_id);

    AccountYear accYear = ((is.idega.idegaweb.golf.entity.AccountYearHome)com.idega.data.IDOLookup.getHomeLegacy(AccountYear.class)).findByPrimaryKeyLegacy(account_year_id);
    ...
    Payment[] payments = (Payment[]) (((is.idega.idegaweb.golf.entity.PaymentHome)com.idega.data.IDOLookup.getHomeLegacy(Payment.class)).createLegacy()).findAll(sql.toString());
  ...
  private String getMemberPaymentsString(int member_id,int un_id,List payments)throws SQLException{
    ...
    Member M = ((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(member_id);
    ...
    if(UMI !=null && UMI.getCardId()>0)
      ...
      card = ((is.idega.idegaweb.golf.entity.CardHome)com.idega.data.IDOLookup.getHomeLegacy(Card.class)).findByPrimaryKeyLegacy(UMI.getCardId());
