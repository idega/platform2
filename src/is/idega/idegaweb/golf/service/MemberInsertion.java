    ...
    public String update() {
            ...
            try {
                ...
                if(m_oAddressArr[0] != null)
                    ...
                    counter = m_oMember.getNumberOfRecordsReverseRelated(((is.idega.idegaweb.golf.entity.AddressHome)com.idega.data.IDOLookup.getHomeLegacy(Address.class)).createLegacy());
                ...
                if(m_oPhoneArr[0] != null)
                    ...
                    counter = m_oMember.getNumberOfRecordsReverseRelated(((is.idega.idegaweb.golf.entity.PhoneHome)com.idega.data.IDOLookup.getHomeLegacy(Phone.class)).createLegacy());

                    //counter = m_oPhoneArr[0].getNumberOfRecordsRelated(((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).createLegacy());
