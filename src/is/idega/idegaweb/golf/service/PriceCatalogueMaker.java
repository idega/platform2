...
public class PriceCatalogueMaker extends com.idega.presentation.PresentationObjectContainer {
  ...
  private void control(IWContext iwc) throws IOException{
   ...
   // catch(Exception E){ E.printStackTrace(); add("<br> villa "+E.toString()  );}
    ...
    private void doMain(IWContext iwc) throws SQLException {
      ...
      PriceCatalogue[] Catalogs = (PriceCatalogue[]) (((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy()).findAll("select * from price_catalogue where union_id = '"+union_id+"' and in_use = 'Y' and is_independent = 'Y'");
   ...
   // PriceCatalogue[] Catalogs = (PriceCatalogue[])(((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy()).findAllByColumn("union_id",unionID,"in_use","Y");
  ...
  //PriceCatalogue[] pcls = (PriceCatalogue[]) (((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy()).findAllByColumn("union_id",union_id,"in_use","Y");

    PriceCatalogue[] pcls= (PriceCatalogue[]) (((is.idega.idegaweb.golf.entity.PriceCatalogueHome)com.idega.data.IDOLookup.getHomeLegacy(PriceCatalogue.class)).createLegacy()).findAll("select * from price_catalogue where union_id = '"+union_id+"' and in_use = 'Y' and is_independent = 'Y'");
