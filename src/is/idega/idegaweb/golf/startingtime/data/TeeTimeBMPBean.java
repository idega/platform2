...
public class TeeTimeBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.startingtime.data.TeeTime {
  ...
  public TeeTimeBMPBean(int id) throws SQLException{
