...
/*
 * Copyright 2000-2001 idega.is All Rights Reserved. $id$
 */
 ...
 *         href="mailto:gimmi@idega.is">Grímur Jónsson </a>, <a
 *         href="mailto:laddi@idega.is">Þórhallur Helgason </a>
 */
...
public class TournamentController {
	...
	public static boolean setupStartingtime(IWContext modinfo, is.idega.idegaweb.golf.entity.Member member, Tournament tournament, int tournament_round_id, int startingGroup) throws SQLException {
		return setupStartingtime(modinfo, member, tournament, tournament_round_id, startingGroup, 1);
	}

	public static boolean setupStartingtime(IWContext modinfo, is.idega.idegaweb.golf.entity.Member member, Tournament tournament, int tournament_round_id, int startingGroup, int tee_number) throws SQLException {
	...
	public static boolean blockStartingtime(IWContext modinfo, String name, int tournament_round_id, int startingGroup, int finishingGroup) throws SQLException {
	...
	public static boolean unblockStartingtime(IWContext modinfo, int tournament_round_id, int startingGroup, int finishingGroup) throws SQLException {
		TournamentRound tourRound = null;
		try {
			tourRound = ((TournamentRoundHome) IDOLookup.getHomeLegacy(TournamentRound.class)).findByPrimaryKey(tournament_round_id);
		}
	...
	public static TournamentStartingtimeList getStartingtimeTable(Tournament tournament, String tournament_round_id, boolean viewOnly, boolean forPrinting) throws SQLException {
		return TournamentController.getStartingtimeTable(tournament, tournament_round_id, viewOnly, false, true, forPrinting);
	}

	public static TournamentStartingtimeList getStartingtimeTable(Tournament tournament, String tournament_round_id, boolean viewOnly) throws SQLException {
		return TournamentController.getStartingtimeTable(tournament, tournament_round_id, viewOnly, false, true);
	}

	public static TournamentStartingtimeList getStartingtimeTable(Tournament tournament, String tournament_round_id, boolean viewOnly, boolean onlineRegistration, IWResourceBundle iwrb) throws SQLException {
		return TournamentController.getStartingtimeTable(tournament, tournament_round_id, viewOnly, onlineRegistration, true);
	}

	public static TournamentStartingtimeList getStartingtimeTable(Tournament tournament, String tournament_round_id, boolean viewOnly, boolean onlineRegistration, boolean useBorder) throws SQLException {
		return TournamentController.getStartingtimeTable(tournament, tournament_round_id, viewOnly, onlineRegistration, useBorder, false);
	}

	public static TournamentStartingtimeList getStartingtimeTable(Tournament tournament, String tournament_round_id, boolean viewOnly, boolean onlineRegistration, boolean useBorder, boolean forPrinting) throws SQLException {
	...
	public static StartingtimeView[] getStartingtimeView(int tournament_round_id, String column_name, String column_value, String column_name_1, String column_value_1, int tee_number, String order) throws SQLException {
		return TournamentController.getStartingtimeView(tournament_round_id, column_name, column_value, column_name_1, column_value_1, tee_number, order, -1, -1);
	}

	public static StartingtimeView[] getStartingtimeView(int tournament_round_id, String column_name, String column_value, String column_name_1, String column_value_1, int tee_number, String order, int first_group_number, int last_group_number) throws SQLException {
	...
	public static void removeMemberFromTournament(IWContext modinfo, Tournament tournament, is.idega.idegaweb.golf.entity.Member member, int startingGroupNumber) {
