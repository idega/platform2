...
private Table resultTable;
  ...
  private void getFormTable() {
    ...
    DropdownMenu genderMenu = new DropdownMenu("gender");
	  genderMenu.setStyleAttribute(getStyle());
    ...
    DropdownMenu groupsMenu = new DropdownMenu("tournament_group_id");
	  groupsMenu.setStyleAttribute(getStyle());
    ...
    DropdownMenu roundsMenu = new DropdownMenu("tournament_round_id");
	  roundsMenu.setStyleAttribute(getStyle());
    ...
    DropdownMenu scoreMenu = new DropdownMenu("sort");
      scoreMenu.setStyleAttribute(getStyle());
    ...
    DropdownMenu orderMenu = new DropdownMenu("order");
      orderMenu.setStyleAttribute(getStyle());
  ...
  private void getHoleByHole() {
	...
	Window scoreWindow = new Window(iwrb.getLocalizedString("tournament.holeview_window","Hole view"),796,600,"/tournament/holeview.jsp");
