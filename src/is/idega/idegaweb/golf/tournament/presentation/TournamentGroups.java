...
public void confirm(IWContext modinfo,IWResourceBundle iwrb)throws Exception{
          //GolfDialog dialog = new GolfDialog(iwrb.getLocalizedString("tournament.warning","Warning"));
          //add(dialog);
...
public void delete(IWContext modinfo,IWResourceBundle iwrb)throws Exception{
          //GolfDialog dialog = new GolfDialog(iwrb.getLocalizedString("tournament.confirmation","Confirmation"));
          //add(dialog);
