...
public class TournamentFormBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.TournamentForm {



	public TournamentFormBMPBean(){
	...
	public TournamentFormBMPBean(int id)throws SQLException{
