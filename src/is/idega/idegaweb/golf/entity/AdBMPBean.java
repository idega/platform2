...
public class AdBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.Ad {
	...
	public AdBMPBean(int id)throws SQLException{
