...
public class MemberInfoBMPBean extends com.idega.data.GenericEntity implements is.idega.idegaweb.golf.entity.MemberInfo {



	public MemberInfoBMPBean(){
	...
	public MemberInfoBMPBean(int id)throws SQLException{
