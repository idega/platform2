...
public class TournamentGroupBMPBean extends GroupBMPBean implements TournamentGroup{
	...
	public void initializeAttributes(){
		...
		addAttribute("union_id","Stofnað undir",true,true,java.lang.Integer.class,"one-to-many",Union.class);
		addAttribute("tee_color_id","Spilar á teig",true,true,java.lang.Integer.class,"one-to-many",is.idega.idegaweb.golf.entity.TeeColor.class);
		addAttribute("handicap_min","Lágmarksforgjöf", true, true, java.lang.Float.class);
		addAttribute("handicap_max","Hámarksforgjöf", true, true, java.lang.Float.class);
		addAttribute("age_min","Lágmarksaldur", true, true, java.lang.Integer.class);
		addAttribute("age_max","Hámarksaldur", true, true, java.lang.Integer.class);
