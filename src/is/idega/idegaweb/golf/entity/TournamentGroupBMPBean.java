...
public class TournamentGroupBMPBean extends GroupBMPBean implements is.idega.idegaweb.golf.entity.TournamentGroup {
	...
	public TournamentGroupBMPBean(int id)throws SQLException{
	...
	public void initializeAttributes(){
		...
		addAttribute("union_id","Stofnað undir",true,true,"java.lang.Integer","one-to-many","is.idega.idegaweb.golf.entity.Union");

		addAttribute("tee_color_id","Spilar á teig",true,true,"java.lang.Integer","one-to-many","is.idega.idegaweb.golf.entity.TeeColor");
