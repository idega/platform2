...
public class ZipCodeBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.ZipCode {



	public ZipCodeBMPBean(){
	...
	public ZipCodeBMPBean(int id)throws SQLException{
