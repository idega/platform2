...
public class TournamentDayBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.TournamentDay {



	public TournamentDayBMPBean(){
	...
	public TournamentDayBMPBean(int id)throws SQLException{
