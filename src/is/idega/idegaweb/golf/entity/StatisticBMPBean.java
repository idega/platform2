...
public class StatisticBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.Statistic {
	...
	public StatisticBMPBean(int id)throws SQLException{
