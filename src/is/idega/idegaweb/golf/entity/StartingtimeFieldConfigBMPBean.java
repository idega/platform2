...
public class StartingtimeFieldConfigBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.StartingtimeFieldConfig {
  ...
  public StartingtimeFieldConfigBMPBean(int id) throws SQLException{
