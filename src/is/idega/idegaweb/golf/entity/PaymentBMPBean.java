...
public class PaymentBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.Payment {



	public PaymentBMPBean(){
	...
	public PaymentBMPBean(int id)throws SQLException{
