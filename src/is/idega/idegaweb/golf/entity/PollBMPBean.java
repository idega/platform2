...
public class PollBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.Poll {
	...
	public void initializeAttributes(){
		...
		addAttribute("union_id", "Félag", true, true, "java.lang.Integer","many-to-one","is.idega.idegaweb.golf.entity.Union");
	...
	public Poll_option[] findOptions()throws SQLException{
		...
		return (Poll_option[]) findAssociated(((is.idega.idegaweb.golf.entity.Poll_optionHome)com.idega.data.IDOLookup.getHomeLegacy(Poll_option.class)).createLegacy());
	...
	public void delete() throws SQLException{
		...
		Poll_option[] options = (Poll_option[])(((is.idega.idegaweb.golf.entity.Poll_optionHome)com.idega.data.IDOLookup.getHomeLegacy(Poll_option.class)).createLegacy()).findAllByColumn("poll_id",Integer.toString(this.getID()));
