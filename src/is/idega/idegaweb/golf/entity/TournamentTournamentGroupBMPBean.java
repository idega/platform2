...
public class TournamentTournamentGroupBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.TournamentTournamentGroup {



	public TournamentTournamentGroupBMPBean(){
	...
	public TournamentTournamentGroupBMPBean(int id)throws SQLException{
