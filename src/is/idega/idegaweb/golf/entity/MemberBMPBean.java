...
public class MemberBMPBean extends com.idega.data.genericentity.MemberBMPBean implements Member {
  ...
  public MemberInfo getMemberInfo(){
    ...
    try{
      ...
      MemberInfo mem = ((is.idega.idegaweb.golf.entity.MemberInfoHome)com.idega.data.IDOLookup.getHomeLegacy(MemberInfo.class)).createLegacy();
      ...
      //MemberInfo tempMem = ((is.idega.idegaweb.golf.entity.MemberInfoHome)com.idega.data.IDOLookup.getHomeLegacy(MemberInfo.class)).findByPrimaryKeyLegacy(this.getID());
  ...
  public UnionMemberInfo getUnionMemberInfo(String union_id)throws SQLException{
    ...
    UnionMemberInfo info = ((is.idega.idegaweb.golf.entity.UnionMemberInfoHome)com.idega.data.IDOLookup.getHomeLegacy(UnionMemberInfo.class)).createLegacy();
  ...
  public int getMainUnionID() throws SQLException {
    ...
    UnionMemberInfo[] union = (UnionMemberInfo[]) is.idega.idegaweb.golf.entity.UnionMemberInfoBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.UnionMemberInfo").findAll("select * from union_member_info where member_id = "+this.getID());
    ...
    try{
      ...
      if ( union.length == 0 ) {
        ...
        Union[] unionMember = (Union[]) this.findRelated(((is.idega.idegaweb.golf.entity.UnionHome)com.idega.data.IDOLookup.getHomeLegacy(Union.class)).createLegacy());
  ...
  public void setMainUnion(int iUnionId) throws SQLException {
    ...
    UnionMemberInfo[] unies = (UnionMemberInfo[]) (((is.idega.idegaweb.golf.entity.UnionMemberInfoHome)com.idega.data.IDOLookup.getHomeLegacy(UnionMemberInfo.class)).createLegacy()).findAllByColumn("member_id",this.getID());
  ...
  public Union getMainUnion()throws SQLException{
    ...
    return ((is.idega.idegaweb.golf.entity.UnionHome)com.idega.data.IDOLookup.getHomeLegacy(Union.class)).findByPrimaryKeyLegacy(getMainUnionID());
  ...
  public Address[] getAddress()throws SQLException{
    ...
    return ((Address[]) findReverseRelated(((is.idega.idegaweb.golf.entity.AddressHome)com.idega.data.IDOLookup.getHomeLegacy(Address.class)).createLegacy()));
  ...
  public Scorecard[] getScorecards()throws SQLException{
    ...
    Scorecard scorecard = ((is.idega.idegaweb.golf.entity.ScorecardHome)com.idega.data.IDOLookup.getHomeLegacy(Scorecard.class)).createLegacy();
  ...
  public Union[] getUnions()throws SQLException{
    ...
    Union union = (Union)is.idega.idegaweb.golf.entity.UnionBMPBean.getStaticInstance();
    ...
    UnionMemberInfo[] unioninfos = (UnionMemberInfo[]) is.idega.idegaweb.golf.entity.UnionMemberInfoBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.UnionMemberInfo").findAll("select * from union_member_info where member_id = "+this.getID());

    Vector vect = new Vector();

    for (int i = 0; i < unioninfos.length; i++) {

      vect.add(((is.idega.idegaweb.golf.entity.UnionHome)com.idega.data.IDOLookup.getHomeLegacy(Union.class)).findByPrimaryKeyLegacy(unioninfos[i].getUnionID()));
  ...
  public Phone[] getPhone()throws SQLException {
          ...
          return (Phone[]) this.findReverseRelated(((is.idega.idegaweb.golf.entity.PhoneHome)com.idega.data.IDOLookup.getHomeLegacy(Phone.class)).createLegacy());
  ...
  public void delete()throws SQLException{
    ...
    try{
      ...
      try{
        ...
        Card card = ((is.idega.idegaweb.golf.entity.CardHome)com.idega.data.IDOLookup.getHomeLegacy(Card.class)).createLegacy();
      ...
      try{
        ...
        //MemberInfo info = ((is.idega.idegaweb.golf.entity.MemberInfoHome)com.idega.data.IDOLookup.getHomeLegacy(MemberInfo.class)).findByPrimaryKeyLegacy(this.getID());
...
*/
      ...
      try{
        ...
        Scorecard[] scores = (Scorecard[])(((is.idega.idegaweb.golf.entity.ScorecardHome)com.idega.data.IDOLookup.getHomeLegacy(Scorecard.class)).createLegacy()).findAllByColumn("member_id",this.getID());

        for (int i = 0; i < scores.length;i++){

          Stroke	stroke = ((is.idega.idegaweb.golf.entity.StrokeHome)com.idega.data.IDOLookup.getHomeLegacy(Stroke.class)).createLegacy();
      ...
      try{
        ...
        Startingtime time = ((is.idega.idegaweb.golf.entity.StartingtimeHome)com.idega.data.IDOLookup.getHomeLegacy(Startingtime.class)).createLegacy();
      ...
      try{
        ...
        is.idega.idegaweb.golf.entity.PaymentBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.Payment").deleteMultiple("member_id",Integer.toString(this.getID()));
      ...
      try{
        ...
        Account[] account = (Account[]) is.idega.idegaweb.golf.entity.AccountBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.Account").findAllByColumn("member_id",this.getID());

        for ( int a = 0; a < account.length; a++ ) {

          is.idega.idegaweb.golf.entity.AccountEntryBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.AccountEntry").deleteMultiple("account_id",Integer.toString(account[a].getID()));
      ...
      try{
        ...
        is.idega.idegaweb.golf.entity.LoginTableBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.LoginTable").deleteMultiple("member_id",Integer.toString(this.getID()));
  ...
  public static com.idega.data.genericentity.Member getMember(String socialSecurityNumber) {
      ...
      try {
          ...
          java.util.List members = com.idega.data.EntityFinder.findAllByColumn(((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(is.idega.idegaweb.golf.entity.Member.class)).createLegacy(),"SOCIAL_SECURITY_NUMBER",socialSecurityNumber);
