 ...
 * $Id: TournamentRoundBMPBean.java,v 1.1 2002/04/06 19:11:19 tryggvil Exp $
...
public class TournamentRoundBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.TournamentRound {



	public TournamentRoundBMPBean(){
	...
	public TournamentRoundBMPBean(int id)throws SQLException{
	...
	public Startingtime[] getStartingtimes() throws SQLException {
		...
		return (Startingtime[]) (is.idega.idegaweb.golf.entity.StartingtimeBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.Startingtime")).findRelated(this);
  ...
  public void delete() throws SQLException {
    ...
    try {
      ...
      List scorecards = EntityFinder.findAllByColumn(((is.idega.idegaweb.golf.entity.ScorecardHome)com.idega.data.IDOLookup.getHomeLegacy(Scorecard.class)).createLegacy(),"TOURNAMENT_ROUND_ID", this.getID());
    ...
    try {
      ...
      Startingtime[] startingtimes = (Startingtime[]) (((is.idega.idegaweb.golf.entity.StartingtimeHome)com.idega.data.IDOLookup.getHomeLegacy(Startingtime.class)).createLegacy()).findAll("SELECT startingtime.* from startingtime s, tournament_round_startingtime trs where s.startingtime_id = trs.startingtime_id AND trs.tournament_round_id = "+this.getID());
