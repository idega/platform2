...
public class PaymentRoundBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.PaymentRound {



	public PaymentRoundBMPBean(){
	...
	public PaymentRoundBMPBean(int id)throws SQLException{
