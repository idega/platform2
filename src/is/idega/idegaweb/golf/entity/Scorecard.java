...
public class Scorecard extends GolfEntity{
	...
	public void setUpdateHandicap(boolean handicap){
        ...
        public void delete() throws SQLException{
            ...
            Stroke.getStaticInstance("is.idega.idegaweb.golf.entity.Stroke").deleteMultiple("scorecard_id",Integer.toString(this.getID())); //.findAllByColumn("SCORECARD_ID",this.getID());
            ...
            System.out.println(new com.idega.util.idegaTimestamp().getTimestampRightNow().toString());
            Statistic.getStaticInstance("is.idega.idegaweb.golf.entity.Statistic").deleteMultiple("scorecard_id",Integer.toString(this.getID())); //.findAllByColumn("scorecard_id",this.getID());
