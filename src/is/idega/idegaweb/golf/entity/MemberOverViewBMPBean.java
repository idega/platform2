...
public class MemberOverViewBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.MemberOverView {



	public MemberOverViewBMPBean(){
	...
	public MemberOverViewBMPBean(int id)throws SQLException{
