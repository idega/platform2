...
public class SubscriptionBMPBean extends com.idega.data.GenericEntity implements Subscription {



	public SubscriptionBMPBean(){
	...
	public SubscriptionBMPBean(int id)throws SQLException{
