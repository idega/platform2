...
public class TournamentBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.Tournament {
	...
	public TournamentBMPBean(int id) throws SQLException{
	...
	public TournamentRound[] getTournamentRounds()throws SQLException{
		...
		return (TournamentRound[]) (((is.idega.idegaweb.golf.entity.TournamentRoundHome)com.idega.data.IDOLookup.getHomeLegacy(TournamentRound.class)).createLegacy()).findAllByColumnOrdered("tournament_id",Integer.toString(this.getID()),"ROUND_NUMBER");
	...
	public TournamentGroup[] getTournamentGroups()throws SQLException{
		...
		return (TournamentGroup[]) findRelated(((is.idega.idegaweb.golf.entity.TournamentGroupHome)com.idega.data.IDOLookup.getHomeLegacy(TournamentGroup.class)).createLegacy());
   ...
   public TournamentDay[] getTournamentDays()throws SQLException{
      ...
      return (TournamentDay[])(((is.idega.idegaweb.golf.entity.TournamentDayHome)com.idega.data.IDOLookup.getHomeLegacy(TournamentDay.class)).createLegacy()).findAllByColumn("tournament_id",this.getID());
   ...
   public TeeColor[] getTeeColors()throws SQLException{
      ...
      return (TeeColor[])findRelated(((is.idega.idegaweb.golf.entity.TeeColorHome)com.idega.data.IDOLookup.getHomeLegacy(TeeColor.class)).createLegacy());
	...
	public void delete()throws SQLException{
        ...
        public void deleteAllData() throws SQLException {
            ...
            try {
                ...
                is.idega.idegaweb.golf.entity.MemberBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.Member").reverseRemoveFrom(this);
            ...
            try {
                ...
                StartingtimeFieldConfig[] sFieldConfig = (StartingtimeFieldConfig[]) (((is.idega.idegaweb.golf.entity.StartingtimeFieldConfigHome)com.idega.data.IDOLookup.getHomeLegacy(StartingtimeFieldConfig.class)).createLegacy()).findAllByColumn("tournament_id",this.getID()+"") ;
            ...
            try{
                ...
                is.idega.idegaweb.golf.entity.TeeColorBMPBean.getStaticInstance("is.idega.idegaweb.golf.entity.TeeColor").removeFrom(this);
            ...
            try {
                ...
                Startingtime[] stimes = (Startingtime[]) (((is.idega.idegaweb.golf.entity.StartingtimeHome)com.idega.data.IDOLookup.getHomeLegacy(Startingtime.class)).createLegacy()).findAll("Select startingtime.* from startingtime ,tournament_startingtime where startingtime.startingtime_id = tournament_startingtime.startingtime_id AND tournament_id = "+this.getID());
