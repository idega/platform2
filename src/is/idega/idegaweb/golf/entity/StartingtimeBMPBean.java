...
public class StartingtimeBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.Startingtime {



  public StartingtimeBMPBean() {

  }



  public StartingtimeBMPBean(int id) throws SQLException{
  ...
  public Member getMember()throws SQLException{
	...
	try{
          ...
          member = ((is.idega.idegaweb.golf.entity.MemberHome)com.idega.data.IDOLookup.getHomeLegacy(Member.class)).findByPrimaryKeyLegacy(getMemberID());
