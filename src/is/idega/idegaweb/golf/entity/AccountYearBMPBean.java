...
public class AccountYearBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.AccountYear {



	public AccountYearBMPBean(){
	...
	public AccountYearBMPBean(int id)throws SQLException{
