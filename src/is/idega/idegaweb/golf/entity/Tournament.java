   ...
   public TeeColor[] getTeeColors()throws SQLException{
	...
	public void delete()throws SQLException{
        ...
        public void deleteAllData() throws SQLException {
            try {
                Member.getStaticInstance("is.idega.idegaweb.golf.entity.Member").reverseRemoveFrom(this);
            }
            ...
            try{
                TeeColor.getStaticInstance("is.idega.idegaweb.golf.entity.TeeColor").removeFrom(this);
            }
            catch (Exception e) {e.printStackTrace(System.err);}
