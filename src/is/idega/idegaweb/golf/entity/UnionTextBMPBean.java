...
public class UnionTextBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.UnionText {



	public UnionTextBMPBean(){
	...
	public UnionTextBMPBean(int id)throws SQLException{
