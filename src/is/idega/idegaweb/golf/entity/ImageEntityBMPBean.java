...
public class ImageEntityBMPBean extends GenericEntity implements ImageEntity{
	...
	public void insertStartData() throws Exception {
		ImageEntity image = ((ImageEntityHome) IDOLookup.getHomeLegacy(ImageEntity.class)).create();
		image.setName("Default no image");
		image.insert();
		ImageEntity image2 = ((ImageEntityHome) IDOLookup.getHomeLegacy(ImageEntity.class)).create();
		image2.setID(-1);
