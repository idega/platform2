...
public class FieldBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.Field {
	...
	public FieldBMPBean(int id)throws SQLException{
