...
public class FieldImageBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.FieldImage {



	public FieldImageBMPBean(){
	...
	public FieldImageBMPBean(int id)throws SQLException{
