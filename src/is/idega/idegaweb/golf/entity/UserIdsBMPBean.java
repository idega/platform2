...
public class UserIdsBMPBean extends com.idega.data.GenericEntity implements is.idega.idegaweb.golf.entity.UserIds {



	public UserIdsBMPBean(){

		super();

	}

	public UserIdsBMPBean(int id)throws SQLException{
