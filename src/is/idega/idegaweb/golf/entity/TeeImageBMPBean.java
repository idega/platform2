...
public class TeeImageBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.TeeImage {



	public TeeImageBMPBean(){
	...
	public TeeImageBMPBean(int id)throws SQLException{
