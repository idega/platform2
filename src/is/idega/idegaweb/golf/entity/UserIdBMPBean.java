...
public class UserIdBMPBean extends com.idega.data.GenericEntity implements is.idega.idegaweb.golf.entity.UserId {



    public UserIdBMPBean(){

            super();

    }

    public UserIdBMPBean(int id)throws SQLException{
