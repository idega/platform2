...
public class PriceCatalogueBMPBean extends is.idega.idegaweb.golf.entity.GolfEntityBMPBean implements is.idega.idegaweb.golf.entity.PriceCatalogue {



	public PriceCatalogueBMPBean(){
	...
	public PriceCatalogueBMPBean(int id)throws SQLException{
