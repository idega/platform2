...
public class GolfMemberProfile {
  ...
  private void fillProfile(){
    ...
    try {
      ...
      eUMIs = (UnionMemberInfo[]) ((is.idega.idegaweb.golf.entity.UnionMemberInfoHome)com.idega.data.IDOLookup.getHomeLegacy(UnionMemberInfo.class)).createLegacy().findAllByColumn(eMember.getIDColumnName(),eMember.getID());
    ...
    if(eUMI != null && eUMI.getFamilyId() > 0){
      ...
      try {
        ...
        eFamily = ((is.idega.idegaweb.golf.entity.FamilyHome)com.idega.data.IDOLookup.getHomeLegacy(Family.class)).findByPrimaryKeyLegacy(eUMI.getFamilyId());
      ...
      try {
        ...
        if(id > 1)
          ...
          eCard = ((is.idega.idegaweb.golf.entity.CardHome)com.idega.data.IDOLookup.getHomeLegacy(Card.class)).findByPrimaryKeyLegacy(id);
