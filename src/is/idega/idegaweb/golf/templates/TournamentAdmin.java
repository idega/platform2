...
import is.idega.idegaweb.golf.moduleobject.*;
...
public abstract class TournamentAdmin extends JmoduleWindowModule{
  ...
  private final static String IW_BUNDLE_IDENTIFIER="com.idega.idegaweb.golf";
	...
	public void setTournament(String tournament_id)throws Exception{
		...
		setSessionAttribute("tournament_admin_tournament",((is.idega.idegaweb.golf.entity.TournamentHome)com.idega.data.IDOLookup.getHomeLegacy(Tournament.class)).findByPrimaryKeyLegacy(Integer.parseInt(tournament_id)));
 ...
 */
        ...
        public void _main(IWContext iwc)throws Exception{
          ...
          getPage().setTitle("idegaWeb Golf");
